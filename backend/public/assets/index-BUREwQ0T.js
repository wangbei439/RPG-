(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const r of document.querySelectorAll('link[rel="modulepreload"]'))i(r);new MutationObserver(r=>{for(const o of r)if(o.type==="childList")for(const s of o.addedNodes)s.tagName==="LINK"&&s.rel==="modulepreload"&&i(s)}).observe(document,{childList:!0,subtree:!0});function n(r){const o={};return r.integrity&&(o.integrity=r.integrity),r.referrerPolicy&&(o.referrerPolicy=r.referrerPolicy),r.crossOrigin==="use-credentials"?o.credentials="include":r.crossOrigin==="anonymous"?o.credentials="omit":o.credentials="same-origin",o}function i(r){if(r.ep)return;r.ep=!0;const o=n(r);fetch(r.href,o)}})();const wt=`${window.location.origin}/api`,It=window.localStorage.getItem("rpg_generator_api_base")||"",St=(It||wt).replace(/\/$/,"");async function Et(e){try{const t=await e.json();return(t==null?void 0:t.error)||(t==null?void 0:t.message)||`${e.status} ${e.statusText}`}catch{return`${e.status} ${e.statusText}`}}async function f(e,t={}){const n=await fetch(`${St}${e}`,t);if(!n.ok)throw new Error(await Et(n));return n.json()}function y(e,t){return{method:e,headers:{"Content-Type":"application/json"},body:JSON.stringify(t)}}const Ze={openai:{apiUrl:{id:"openai-url",fallback:"https://api.openai.com/v1"},apiKey:{id:"openai-key"},model:{id:"openai-model",fallback:"gpt-4o"}},anthropic:{apiKey:{id:"anthropic-key"},model:{id:"anthropic-model",fallback:"claude-3-5-sonnet-20241022"}},local:{apiUrl:{id:"ollama-url",fallback:"http://localhost:11434"},model:{id:"ollama-model",fallback:"llama3"}},custom:{apiUrl:{id:"custom-url"},apiKey:{id:"custom-key"},model:{id:"custom-model"}}},et={difficulty:{id:"game-difficulty",fallback:"normal"},length:{id:"game-length",fallback:"medium"},enableImages:{id:"enable-images",type:"checkbox",fallback:!0},imageSource:{id:"image-source",fallback:"comfyui"},imageGenerationMode:{id:"image-generation-mode",fallback:"manual"},comfyuiUrl:{id:"comfyui-url",fallback:"http://127.0.0.1:8000"},comfyuiImageCount:{id:"comfyui-image-count",fallback:"1"},comfyuiModel:{id:"comfyui-model",fallback:""},comfyuiSampler:{id:"comfyui-sampler",fallback:"euler"},comfyuiScheduler:{id:"comfyui-scheduler",fallback:"normal"},comfyuiWidth:{id:"comfyui-width",fallback:"768"},comfyuiHeight:{id:"comfyui-height",fallback:"512"},comfyuiSteps:{id:"comfyui-steps",fallback:"20"},comfyuiCfg:{id:"comfyui-cfg",fallback:"7.5"},comfyuiSeed:{id:"comfyui-seed",fallback:"-1"},comfyuiTimeoutMs:{id:"comfyui-timeout-ms",fallback:"180000"},comfyuiPromptPrefix:{id:"comfyui-prompt-prefix",fallback:"RPG game scene"},comfyuiPromptSuffix:{id:"comfyui-prompt-suffix",fallback:"high quality, detailed, fantasy art style"},comfyuiNegativePrompt:{id:"comfyui-negative-prompt",fallback:"low quality, blurry, deformed, ugly, bad anatomy, watermark, text"},comfyuiFilenamePrefix:{id:"comfyui-filename-prefix",fallback:"rpg_scene"},comfyuiWorkflowMode:{id:"comfyui-workflow-mode",fallback:"custom"},comfyuiWorkflowFile:{id:"comfyui-workflow-file",fallback:""},comfyuiWorkflowJson:{id:"comfyui-workflow-json",fallback:""},imageApiUrl:{id:"image-api-url",fallback:""},imageApiKey:{id:"image-api-key",fallback:""}};function kt(e,t){var n;return((n=t.getElementById(e))==null?void 0:n.value)||""}function Bt(e,t){const n=t.getElementById(e.id);return n?e.type==="checkbox"?n.checked:n.value||e.fallback||"":e.fallback}function $t(e,t,n){const i=n.getElementById(e);i&&t!==void 0&&(i.value=t)}function Pt(e,t,n){const i=n.getElementById(e.id);if(!(!i||t===void 0)){if(e.type==="checkbox"){i.checked=!!t;return}i.value=t}}function oe(e=null,t=document){const n=e||t.getElementById("llm-source").value,i=Ze[n]||{},r={llmSource:n};for(const[o,s]of Object.entries(i))r[o]=kt(s.id,t)||s.fallback||"";return r}function Lt(e,t=document){const n=e.llmSource||"openai";t.getElementById("llm-source").value=n,t.getElementById("llm-source").dispatchEvent(new Event("change"));const i=Ze[n]||{};for(const[r,o]of Object.entries(i))$t(o.id,e[r]||o.fallback||"",t)}function N(e=document){const t={settings:oe(null,e)};for(const[n,i]of Object.entries(et))t[n]=Bt(i,e);return t}function ze(e={},t=document){for(const[n,i]of Object.entries(et))Pt(i,e[n]??i.fallback,t)}const a={currentGameType:null,currentProjectId:null,currentProjectData:null,currentGameId:null,currentGameData:null,gameState:null,currentGenerationConfig:null,currentSessionId:null,currentStepId:null,allSteps:[],stepStates:{},sceneImages:[],selectedSceneImageIndex:0,lastSuggestedImagePrompt:"",activeSceneImage:"",transitioningSceneImage:"",currentVisualSignature:"",sceneImageTransitionToken:0,runtimeSnapshotTimer:null,runtimeSnapshotSaving:!1},tt="rpg_generator_settings",V="rpg_generator_generation_settings",nt={adventure:"冒险 RPG",dungeon:"地牢探索",romance:"恋爱模拟",mystery:"推理解谜",fantasy:"奇幻魔法",scifi:"科幻星际",survival:"生存挑战",kingdom:"王国建设",cultivation:"修仙问道",custom:"自定义 RPG"},M={worldview:{icon:"世",name:"世界观",desc:"先确定世界背景、主要势力、地点与规则。"},coreCharacters:{icon:"核",name:"核心角色",desc:"生成推动主线的关键角色。"},secondaryCharacters:{icon:"辅",name:"次要角色",desc:"补充世界细节与互动节点。"},items:{icon:"物",name:"物品道具",desc:"生成装备、任务物品和关键奖励。"},puzzles:{icon:"谜",name:"谜题挑战",desc:"设计挑战、机关和探索障碍。"},mainPlot:{icon:"主",name:"主线剧情",desc:"组织章节推进与核心冲突。"},sidePlots:{icon:"支",name:"支线剧情",desc:"补充可选故事和人物支线。"},fragments:{icon:"碎",name:"碎片内容",desc:"生成可探索的世界细节与传闻。"},integration:{icon:"整",name:"整合方案",desc:"把已确认内容整合成最终可玩的方案。"}};document.addEventListener("DOMContentLoaded",()=>{Tt(),Gt(),At(),Ot(),_t(),Ft(),tn(),gn(),it()});function L(e){return a.stepStates[e]||(a.stepStates[e]={candidates:[],selectedIndex:-1,status:"idle",history:[]}),a.stepStates[e]}function b(e){var t;document.querySelectorAll(".screen").forEach(n=>n.classList.remove("active")),(t=document.getElementById(e))==null||t.classList.add("active")}function w(e,t){const n=document.getElementById("api-status-dot"),i=document.getElementById("api-status-text");n&&(n.className="status-dot",n.classList.add(`status-${e}`)),i&&(i.textContent=t)}function te(){const e=document.getElementById("image-source").value;document.getElementById("comfyui-settings").style.display=e==="comfyui"?"block":"none",document.getElementById("api-settings").style.display=e==="api"?"block":"none",at()}function jt(){const e=document.getElementById("comfyui-settings");!e||e.dataset.enhanced==="true"||(e.innerHTML=`
    ...
    `,e.dataset.enhanced="true")}function xt(){const e=document.getElementById("live-image-config");!e||e.dataset.enhanced==="true"||(e.innerHTML=`
    ...
    `,e.dataset.enhanced="true")}function Ct(){const e=document.getElementById("live-comfyui-workflow-mode"),t=document.getElementById("live-comfyui-custom-workflow");!e||!t||(t.style.display=e.value==="custom"?"block":"none")}function at(){const e=document.getElementById("comfyui-workflow-mode"),t=document.getElementById("comfyui-custom-workflow"),n=document.getElementById("comfyui-default-workflow-fields");if(!e||!t||!n)return;const i=e.value==="custom";t.style.display=i?"block":"none",n.style.display=i?"none":"block"}function K(){var e,t,n,i,r,o,s,m,d,c,p,g,v,D,T,R,z,E;return{imageSource:I().imageSource,imageGenerationMode:I().imageGenerationMode,comfyuiUrl:((e=document.getElementById("live-comfyui-url"))==null?void 0:e.value)||"http://127.0.0.1:8000",comfyuiImageCount:((t=document.getElementById("scene-image-count"))==null?void 0:t.value)||"1",comfyuiModel:((n=document.getElementById("live-comfyui-model"))==null?void 0:n.value)||"",comfyuiSampler:((i=document.getElementById("live-comfyui-sampler"))==null?void 0:i.value)||"euler",comfyuiScheduler:((r=document.getElementById("live-comfyui-scheduler"))==null?void 0:r.value)||"normal",comfyuiWidth:((o=document.getElementById("live-comfyui-width"))==null?void 0:o.value)||"768",comfyuiHeight:((s=document.getElementById("live-comfyui-height"))==null?void 0:s.value)||"512",comfyuiSteps:((m=document.getElementById("live-comfyui-steps"))==null?void 0:m.value)||"20",comfyuiCfg:((d=document.getElementById("live-comfyui-cfg"))==null?void 0:d.value)||"7.5",comfyuiSeed:((c=document.getElementById("live-comfyui-seed"))==null?void 0:c.value)||"-1",comfyuiTimeoutMs:((p=document.getElementById("live-comfyui-timeout-ms"))==null?void 0:p.value)||"180000",comfyuiPromptPrefix:((g=document.getElementById("live-comfyui-prompt-prefix"))==null?void 0:g.value)||"",comfyuiPromptSuffix:((v=document.getElementById("live-comfyui-prompt-suffix"))==null?void 0:v.value)||"",comfyuiNegativePrompt:((D=document.getElementById("live-comfyui-negative-prompt"))==null?void 0:D.value)||"",comfyuiFilenamePrefix:((T=document.getElementById("live-comfyui-filename-prefix"))==null?void 0:T.value)||"",comfyuiWorkflowMode:((R=document.getElementById("live-comfyui-workflow-mode"))==null?void 0:R.value)||"custom",comfyuiWorkflowFile:((z=document.getElementById("live-comfyui-workflow-file"))==null?void 0:z.value)||"",comfyuiWorkflowJson:((E=document.getElementById("live-comfyui-workflow-json"))==null?void 0:E.value)||""}}function ne(e,t=""){const n=document.getElementById("comfyui-status");n&&(n.textContent=e,n.className=`helper-text ${t}`.trim())}function S(e={}){const t={...e};return(!t.comfyuiUrl||t.comfyuiUrl==="http://127.0.0.1:8188")&&(t.comfyuiUrl="http://127.0.0.1:8000"),t.imageGenerationMode||(t.imageGenerationMode="manual"),t.comfyuiWorkflowMode||(t.comfyuiWorkflowMode="custom"),t.comfyuiImageCount||(t.comfyuiImageCount="1"),t}function ae(){const e=document.getElementById("llm-source").value;document.querySelectorAll(".api-config").forEach(n=>{n.style.display="none"});const t=document.getElementById(`${e}-config`);t&&(t.style.display="block")}function Tt(){var e,t,n,i;document.querySelectorAll(".type-card").forEach(r=>{r.addEventListener("click",()=>{a.currentGameType=r.dataset.type,a.currentProjectId=null,a.currentProjectData=null,document.querySelectorAll(".type-card").forEach(o=>o.classList.remove("selected")),r.classList.add("selected"),document.getElementById("config-title").textContent=`配置你的${nt[a.currentGameType]||"RPG"}游戏`,b("config-screen")})}),document.getElementById("back-to-home").addEventListener("click",()=>b("home-screen")),(e=document.getElementById("open-import-screen"))==null||e.addEventListener("click",()=>{h("导入后会自动创建项目，并预填到现有生成流程中。"),b("import-screen")}),(t=document.getElementById("back-from-import"))==null||t.addEventListener("click",()=>b("home-screen")),(n=document.getElementById("back-to-import-edit"))==null||n.addEventListener("click",()=>b("import-screen")),(i=document.getElementById("confirm-import-preview"))==null||i.addEventListener("click",async()=>{await Xt()}),document.getElementById("gen-back-to-config").addEventListener("click",()=>{b(a.currentProjectId?"import-screen":"config-screen")}),document.getElementById("exit-game").addEventListener("click",()=>{confirm("确定退出当前游戏吗？未保存进度将会丢失。")&&(a.currentGameId=null,a.gameState=null,b("home-screen"))})}function Gt(){const e=document.getElementById("load-saved-games-btn"),t=document.getElementById("close-saved-games");e==null||e.addEventListener("click",()=>{Nt();const n=document.getElementById("saved-games-section");n&&(n.style.display="block")}),t==null||t.addEventListener("click",()=>{const n=document.getElementById("saved-games-section");n&&(n.style.display="none")})}function At(){var n,i,r,o,s,m,d;const e=document.getElementById("settings-modal"),t=document.getElementById("game-menu-modal");jt(),document.getElementById("settings-btn").addEventListener("click",()=>{e.classList.add("active"),it()}),e.querySelector(".modal-close").addEventListener("click",()=>{e.classList.remove("active")}),t.querySelector(".modal-close").addEventListener("click",()=>{t.classList.remove("active")}),document.getElementById("save-settings").addEventListener("click",()=>{Dt(),e.classList.remove("active")}),document.getElementById("llm-source").addEventListener("change",ae),document.getElementById("image-source").addEventListener("change",async()=>{te(),j(),document.getElementById("image-source").value==="comfyui"&&await refreshComfyUIOptions(!1)}),(n=document.getElementById("comfyui-workflow-mode"))==null||n.addEventListener("change",()=>{at(),j()}),(i=document.getElementById("refresh-comfyui-btn"))==null||i.addEventListener("click",async()=>{await refreshComfyUIOptions(!0)}),(r=document.getElementById("refresh-workflow-files-btn"))==null||r.addEventListener("click",async()=>{await refreshComfyWorkflowFiles(!0)}),(o=document.getElementById("load-workflow-file-btn"))==null||o.addEventListener("click",async()=>{await loadSelectedComfyWorkflowFile(!0)}),(s=document.getElementById("test-comfyui-btn"))==null||s.addEventListener("click",async()=>{await testComfyUIConnection()}),(m=document.getElementById("validate-workflow-btn"))==null||m.addEventListener("click",async()=>{await validateComfyUIWorkflow()}),(d=document.getElementById("comfyui-workflow-file"))==null||d.addEventListener("change",c=>{var v;const p=((v=c.target)==null?void 0:v.value)||"",g=document.getElementById("comfyui-workflow-file");g&&(g.dataset.selectedWorkflow=p),j(),p&&ne(`Selected workflow: ${p}`,"success")}),document.getElementById("test-openai-btn").addEventListener("click",()=>J("openai")),document.getElementById("test-anthropic-btn").addEventListener("click",()=>J("anthropic")),document.getElementById("test-local-btn").addEventListener("click",()=>J("local")),document.getElementById("test-custom-btn").addEventListener("click",()=>J("custom")),document.querySelectorAll('[data-generation-setting="true"]').forEach(c=>{c.addEventListener("change",()=>{j(),q()})}),document.getElementById("enable-images").addEventListener("change",()=>{j(),q()}),ae(),te()}function Dt(){localStorage.setItem(tt,JSON.stringify(oe())),j()}function it(){const e=localStorage.getItem(tt),t=localStorage.getItem(V);try{e&&Lt(JSON.parse(e)),ze(S(t?JSON.parse(t):{})),a.currentGenerationConfig=N(),ae(),te(),q(),a.currentGenerationConfig.imageSource==="comfyui"&&a.currentGenerationConfig.enableImages!==!1&&(refreshComfyUIOptions(!1).catch(n=>{ne(n.message,"error")}),refreshComfyWorkflowFiles(!1).then(()=>{var r;const n=(r=a.currentGenerationConfig)==null?void 0:r.comfyuiWorkflowFile,i=document.getElementById("comfyui-workflow-json");return n&&i&&!i.value.trim()?loadSelectedComfyWorkflowFile(!1,n):null}).catch(n=>{ne(n.message,"error")}))}catch(n){console.error("Load settings error:",n)}}function j(){const e=S(N());a.currentGenerationConfig=e,localStorage.setItem(V,JSON.stringify(e))}function Je(e,t,n={}){return{version:1,gameId:e,title:n.title||(t==null?void 0:t.name)||"未命名存档",type:n.type||a.currentGameType||(t==null?void 0:t.type)||"custom",savedAt:new Date().toISOString(),gameData:n.gameData||a.currentGameData||null,generationConfig:S(n.generationConfig||a.currentGenerationConfig||N()),gameState:t}}function ce(e){var n,i;const t=localStorage.getItem(e);if(!t)return null;try{const r=JSON.parse(t),o=e.replace(/^rpg_save_/,"");return r&&r.version===1&&r.gameState?{gameId:r.gameId||o,title:r.title||((n=r.gameState)==null?void 0:n.name)||"未命名存档",type:r.type||((i=r.gameState)==null?void 0:i.type)||"custom",savedAt:r.savedAt||null,gameData:r.gameData||null,generationConfig:r.generationConfig?S(r.generationConfig):null,gameState:r.gameState}:{gameId:o,title:(r==null?void 0:r.name)||"旧版存档",type:(r==null?void 0:r.type)||"custom",savedAt:null,gameData:null,generationConfig:null,gameState:r}}catch(r){return console.error("Read saved game error:",r),null}}function Mt(){return Object.keys(localStorage).filter(e=>e.startsWith("rpg_save_")).map(e=>ce(e)).filter(Boolean).sort((e,t)=>{const n=e.savedAt?new Date(e.savedAt).getTime():0;return(t.savedAt?new Date(t.savedAt).getTime():0)-n})}function Nt(){const e=document.getElementById("saved-games-list");if(!e)return;const t=Mt();if(!t.length){e.innerHTML='<p class="empty-hint">暂无存档</p>';return}e.innerHTML=t.map(n=>`
        <button type="button" class="saved-game-card" data-saved-game-id="${l(n.gameId)}">
            <div class="saved-game-header">
                ...
                <span class="saved-game-type">${l(nt[n.type]||n.type||"存档")}</span>
            </div>
    ...
    `).join(""),e.querySelectorAll("[data-saved-game-id]").forEach(n=>{n.addEventListener("click",async()=>{await rt(n.dataset.savedGameId)})})}async function rt(e){const t=ce(`rpg_save_${e}`);if(!(t!=null&&t.gameState)){alert("没有找到可读取的存档。");return}let n=!1;try{const r=await f(`/games/${t.gameId}`);a.currentGameData=r.game||t.gameData||null,n=!0}catch{if(t.gameData&&t.generationConfig)try{const o=await f("/games/restore",y("POST",{gameId:t.gameId,gameData:t.gameData,gameState:t.gameState,config:S(t.generationConfig)}));t.gameId=o.gameId||t.gameId,t.gameState=o.gameState||t.gameState,a.currentGameData=t.gameData,n=!0}catch(o){console.error("Restore saved game error:",o)}}a.currentGameId=t.gameId,a.currentGameType=t.type||a.currentGameType,a.gameState=t.gameState,a.sceneImages=[],a.selectedSceneImageIndex=0,t.generationConfig&&(a.currentGenerationConfig=S(t.generationConfig),localStorage.setItem(V,JSON.stringify(a.currentGenerationConfig))),b("game-screen"),X(t.gameState),W([]),n||alert("这个存档已载入画面，但后端运行态未成功恢复。请重新开始后再保存一次，之后即可正常续玩。");const i=document.getElementById("saved-games-section");i&&(i.style.display="none")}function Ot(){document.getElementById("game-config-form").addEventListener("submit",async e=>{if(e.preventDefault(),!a.currentGameType){alert("请先选择一个游戏类型。"),b("home-screen");return}await Rt()})}function _t(){var e,t,n;(e=document.getElementById("import-project-form"))==null||e.addEventListener("submit",async i=>{i.preventDefault(),await Qt()}),(t=document.getElementById("import-package-btn"))==null||t.addEventListener("click",async()=>{await Ht()}),(n=document.getElementById("refresh-import-projects"))==null||n.addEventListener("click",async()=>{await U()}),U().catch(i=>{console.error("Load imported projects error:",i)})}async function Ht(){var n,i,r;const e=document.getElementById("import-package-file"),t=(n=e==null?void 0:e.files)==null?void 0:n[0];if(!t){h("请先选择一个项目包 JSON 文件。","error");return}h("正在解析并导入项目包...","pending");try{const o=await t.text(),s=JSON.parse(o),m=await f("/projects/import-package",y("POST",{package:s}));a.currentProjectId=((i=m.project)==null?void 0:i.id)||null,a.currentProjectData=m.project||null,a.currentGameType=((r=m.project)==null?void 0:r.gameType)||a.currentGameType||"custom",a.currentProjectData&&(document.getElementById("import-title").value=a.currentProjectData.title||""),x(a.currentProjectData),await U(),b("import-preview-screen"),h("项目包导入成功。","success"),u("项目包已恢复，可以继续调整后进入工作台。","success")}catch(o){h(`导入失败：${o.message}`,"error")}}function h(e,t=""){const n=document.getElementById("import-status");n&&(n.textContent=e,n.className=`helper-text ${t}`.trim())}async function ot(e){var t;a.currentSessionId=e.sessionId,a.allSteps=e.steps||[],a.currentStepId=e.firstStep||((t=a.allSteps[0])==null?void 0:t.id)||null,a.stepStates={},b("generation-workbench"),H(),await le(),A(a.currentStepId),gt(),w("idle","已创建生成会话，点击“生成”开始当前步骤。")}async function Rt(){const e=S(N());a.currentGenerationConfig=e,j();const t={userInput:document.getElementById("game-description").value.trim()||"暂无额外描述",gameType:a.currentGameType,config:e};try{const n=await f("/generate/init",y("POST",t));a.currentProjectId=null,a.currentProjectData=null,await ot(n);return}catch(n){console.error("Session init error:",n),alert(`初始化失败：${n.message}`),b("config-screen")}}function Ft(){var e,t,n,i,r,o,s,m,d;(e=document.getElementById("save-import-preview"))==null||e.addEventListener("click",async()=>{await se()}),(t=document.getElementById("optimize-project-btn"))==null||t.addEventListener("click",async()=>{await ie()}),(n=document.getElementById("resume-project-play"))==null||n.addEventListener("click",async()=>{await ct()}),(i=document.getElementById("generate-base-assets"))==null||i.addEventListener("click",async()=>{await st()}),(r=document.getElementById("rebuild-adaptation-btn"))==null||r.addEventListener("click",async()=>{await dt()}),(o=document.getElementById("rebuild-visual-bible-btn"))==null||o.addEventListener("click",async()=>{await mt()}),(s=document.getElementById("apply-project-refinement-btn"))==null||s.addEventListener("click",async()=>{await ut()}),(m=document.getElementById("export-project-package-btn"))==null||m.addEventListener("click",async()=>{await pt()}),(d=document.getElementById("import-preview-screen"))==null||d.addEventListener("click",c=>{const p=c.target.closest("[data-preview-action]");p&&Vt(p.dataset.previewAction,p)})}function u(e,t=""){const n=document.getElementById("import-preview-status");n&&(n.textContent=e,n.className=`helper-text ${t}`.trim())}function Ut(e){return JSON.parse(JSON.stringify(e||{}))}function qt(e=0){return{id:`draft_char_${Date.now()}_${e}`,name:"",role:"",description:""}}function Wt(e=0){return{id:`draft_chapter_${Date.now()}_${e}`,title:`新章节 ${e+1}`,summary:""}}function zt(e=0){return{id:`draft_location_${Date.now()}_${e}`,name:"",description:""}}function Jt(){const e=Ut(a.currentProjectData),t=Y();return e.storyBible=e.storyBible||{},e.source=e.source||{},e.title=t.title||e.title||"",e.storyBible.summary=t.summary||e.storyBible.summary||"",e.storyBible.characters=t.characters,e.storyBible.chapters=t.chapters,e.storyBible.locations=t.locations,e.source.title=e.title||e.source.title||"",e}function Vt(e,t){if(!e||!a.currentProjectData)return;const n=Jt();if(n.storyBible=n.storyBible||{},e==="add-character"){const i=Array.isArray(n.storyBible.characters)?n.storyBible.characters:[];i.push(qt(i.length)),n.storyBible.characters=i}if(e==="remove-character"){const i=t.closest('[data-preview-item="character"]'),r=Number((i==null?void 0:i.dataset.index)??-1);n.storyBible.characters=(n.storyBible.characters||[]).filter((o,s)=>s!==r)}if(e==="add-chapter"){const i=Array.isArray(n.storyBible.chapters)?n.storyBible.chapters:[];i.push(Wt(i.length)),n.storyBible.chapters=i}if(e==="remove-chapter"){const i=t.closest('[data-preview-item="chapter"]'),r=Number((i==null?void 0:i.dataset.index)??-1);n.storyBible.chapters=(n.storyBible.chapters||[]).filter((o,s)=>s!==r)}if(e==="add-location"){const i=Array.isArray(n.storyBible.locations)?n.storyBible.locations:[];i.push(zt(i.length)),n.storyBible.locations=i}if(e==="remove-location"){const i=t.closest('[data-preview-item="location"]'),r=Number((i==null?void 0:i.dataset.index)??-1);n.storyBible.locations=(n.storyBible.locations||[]).filter((o,s)=>s!==r)}a.currentProjectData=n,x(n),u("本地预览已更新，记得保存后再进入工作台。","pending")}function ee(e,t){return Array.from(document.querySelectorAll(`[data-preview-collection="${e}"] [data-preview-item="${e}"]`)).map((n,i)=>t(n,i))}function Y(){var e,t,n,i,r,o,s,m,d;return{title:((e=document.getElementById("import-preview-title"))==null?void 0:e.value.trim())||((t=a.currentProjectData)==null?void 0:t.title)||"",summary:((n=document.getElementById("import-preview-summary-input"))==null?void 0:n.value.trim())||((r=(i=a.currentProjectData)==null?void 0:i.storyBible)==null?void 0:r.summary)||"",adaptationMode:((o=document.getElementById("import-preview-adaptation-mode"))==null?void 0:o.value)||((s=a.currentProjectData)==null?void 0:s.adaptationMode)||"balanced",gameType:((m=document.getElementById("import-preview-game-type"))==null?void 0:m.value)||((d=a.currentProjectData)==null?void 0:d.gameType)||a.currentGameType||"custom",characters:ee("character",(c,p)=>{var g,v,D;return{id:c.dataset.itemId||`import_char_${p+1}`,name:((g=c.querySelector('[data-field="name"]'))==null?void 0:g.value.trim())||"",role:((v=c.querySelector('[data-field="role"]'))==null?void 0:v.value.trim())||"",description:((D=c.querySelector('[data-field="description"]'))==null?void 0:D.value.trim())||""}}).filter(c=>c.name||c.role||c.description),chapters:ee("chapter",(c,p)=>{var g,v;return{id:c.dataset.itemId||`chapter_${p+1}`,title:((g=c.querySelector('[data-field="title"]'))==null?void 0:g.value.trim())||`章节 ${p+1}`,summary:((v=c.querySelector('[data-field="summary"]'))==null?void 0:v.value.trim())||""}}).filter(c=>c.title||c.summary),locations:ee("location",(c,p)=>{var g,v;return{id:c.dataset.itemId||`import_loc_${p+1}`,name:((g=c.querySelector('[data-field="name"]'))==null?void 0:g.value.trim())||"",description:((v=c.querySelector('[data-field="description"]'))==null?void 0:v.value.trim())||""}}).filter(c=>c.name||c.description)}}function x(e=a.currentProjectData){var me,ue,pe,fe,ge,ye,ve,be,he,we,Ie,Se,Ee,ke,Be,$e,Pe,Le,je,xe,Ce,Te,Ge,Ae,De,Me,Ne,Oe,_e,He,Re,Fe,Ue,qe;if(!e)return;const t=document.getElementById("import-preview-summary"),n=document.getElementById("import-preview-characters"),i=document.getElementById("import-preview-chapters"),r=document.getElementById("import-preview-visuals"),o=((me=e.storyBible)==null?void 0:me.summary)||((ue=e.source)==null?void 0:ue.excerpt)||"",s=Array.isArray((pe=e.storyBible)==null?void 0:pe.themes)&&e.storyBible.themes.length?e.storyBible.themes.join("、"):"待补充",m=Array.isArray((fe=e.storyBible)==null?void 0:fe.characters)?e.storyBible.characters:[],d=Array.isArray((ge=e.storyBible)==null?void 0:ge.chapters)?e.storyBible.chapters:[],c=Array.isArray((ye=e.storyBible)==null?void 0:ye.locations)?e.storyBible.locations:[],p=c.slice(0,5).map(k=>k.name).filter(Boolean).join("、"),g=m.slice(0,4).map(k=>k.name).filter(Boolean).join("、"),v=c.slice(0,4).map(k=>k.name).filter(Boolean).join("、"),D=((be=(ve=e.visualBible)==null?void 0:ve.styleProfile)==null?void 0:be.atmosphere)||"待确认",T=((he=e.buildArtifacts)==null?void 0:he.latestPlayable)||null,R=!!((Ie=(we=e.runtimeSnapshot)==null?void 0:we.history)!=null&&Ie.length||((Se=e.runtimeSnapshot)==null?void 0:Se.plotBeatId)!=null),z=T!=null&&T.updatedAt?`最近可玩版本：${new Date(T.updatedAt).toLocaleString()}`:"当前还没有可试玩版本",E=e.optimizationReport||null;if(t&&(t.innerHTML=`
            <div class="preview-summary-block">
                ...
                <div class="preview-content">
                    ...
                    <p>主要地点：${l(p||"待补充")}</p>
                    <p>${l(z)}</p>
                    <p>${l(R?"检测到运行快照，可继续试玩。":"当前没有运行快照，将从开场开始试玩。")}</p>
                </div>
        ...
        `,(Ee=document.getElementById("optimize-project-btn"))==null||Ee.addEventListener("click",async()=>{await ie()}),(ke=document.getElementById("resume-project-play"))==null||ke.addEventListener("click",async()=>{await ct()})),n){const k=m.length?m.map((B,F)=>`
                <article class="preview-edit-item" data-preview-item="character" data-index="${F}" data-item-id="${P(B.id||"")}">
                    <div class="preview-meta-row">
                        <div class="preview-field">
                            <label>角色名</label>
                            <input type="text" data-field="name" value="${P(B.name||"")}" placeholder="角色名称" />
                        </div>
                        <div class="preview-field">
                            <label>角色定位</label>
                            <input type="text" data-field="role" value="${P(B.role||"")}" placeholder="主角 / 配角 / 阵营人物" />
                        </div>
                    </div>
                    <div class="preview-field">
                        <label>角色描述</label>
                        <textarea data-field="description" rows="4" placeholder="补充角色外观、气质、动机">${l(B.description||"")}</textarea>
                    </div>
                    <div class="preview-item-actions">
        ...
        `}if(i){const k=d.length?d.map((B,F)=>`
                <article class="preview-edit-item" data-preview-item="chapter" data-index="${F}" data-item-id="${P(B.id||"")}">
                    <div class="preview-field">
                        <label>章节标题</label>
                        <input type="text" data-field="title" value="${P(B.title||B.name||"")}" placeholder="章节标题" />
                    </div>
                    <div class="preview-field">
                        <label>章节摘要</label>
                        <textarea data-field="summary" rows="5" placeholder="这一章的主要事件与冲突">${l(B.summary||"")}</textarea>
                    </div>
                    <div class="preview-item-actions">
        ...
        `}if(r){const k=c.length?c.map((Z,ht)=>`
                <article class="preview-edit-item" data-preview-item="location" data-index="${ht}" data-item-id="${P(Z.id||"")}">
                    <div class="preview-field">
                        <label>地点名称</label>
                        <input type="text" data-field="name" value="${P(Z.name||"")}" placeholder="地点名称" />
                    </div>
                    <div class="preview-field">
                        <label>地点描述</label>
                        <textarea data-field="description" rows="4" placeholder="地点外观、氛围、功能">${l(Z.description||"")}</textarea>
                    </div>
                    <div class="preview-item-actions">
                        <button type="button" class="preview-inline-btn danger" data-preview-action="remove-location">删除地点</button>
                    </div>
                </article>
            `).join(""):'<p class="empty-hint">地点越准，后面的场景基准图就越稳。</p>',B=(($e=(Be=e.visualBible)==null?void 0:Be.styleProfile)==null?void 0:$e.stylePreset)||"cinematic_cn_rpg",F=((Pe=e.config)==null?void 0:Pe.refinement)||{},We=((Le=e.gameDesign)==null?void 0:Le.branchingPolicy)||{},vt=`每章分支上限 ${We.maxBranchPerChapter||"-"}，锚点保留率 ${We.mustKeepAnchorRate||"-"}`,bt=E?`
                <article class="preview-edit-item">
                    <strong>项目优化诊断</strong>
                    <div class="preview-content">
                        <p>总评分：${l(String(E.overallScore||0))}</p>
                        <p>故事完整度：${l(String(((je=E.readiness)==null?void 0:je.story)||0))}</p>
                        <p>改编完整度：${l(String(((xe=E.readiness)==null?void 0:xe.adaptation)||0))}</p>
                        <p>视觉完整度：${l(String(((Ce=E.readiness)==null?void 0:Ce.visual)||0))}</p>
                        <p>试玩完整度：${l(String(((Te=E.readiness)==null?void 0:Te.playable)||0))}</p>
                    </div>
                    <div class="candidate-block">
                        <div class="candidate-label">优化建议</div>
                        <div class="candidate-paragraph">${l((E.recommendations||[]).join("；")||"当前没有明显阻塞项。")}</div>
                    </div>
                    <div class="candidate-block">
                        <div class="candidate-label">当前优势</div>
                        <div class="candidate-paragraph">${l((E.strengths||[]).join("；")||"继续丰富内容即可。")}</div>
                    </div>
                </article>
            `:"";r.innerHTML=`
            <div class="preview-card-header">
            ...
            <div class="preview-edit-stack">
                <article class="preview-edit-item">
                    <div class="preview-field">
                        ...
                        <input id="preview-style-preset" type="text" value="${P(B)}" placeholder="如 cinematic_cn_rpg / ink_fantasy" />
                    </div>
                    <div class="preview-meta-row">
                        <div class="preview-field">
                            ...
                            <select id="preview-pacing">
                                ...
                                <option value="balanced" ${!((Ae=e.config)!=null&&Ae.pacing)||((De=e.config)==null?void 0:De.pacing)==="balanced"?"selected":""}>平衡</option>
    ...
    `).join("")}}async function st(){var t,n;if(!a.currentProjectId){u("请先导入并保存项目。","error");return}const e=I();!e.enableImages||e.imageSource==="none"?u("当前图像生成未启用，将先以规划模式创建资产索引。","pending"):u("正在生成角色/地点基准图，请稍候...","pending");try{const i={dryRun:!e.enableImages||e.imageSource==="none",characterLimit:4,locationLimit:4,imageConfig:e.imageSource==="comfyui"?{...e,...K()}:e},r=await f(`/projects/${a.currentProjectId}/assets/generate-base`,y("POST",i)),o=await f(`/projects/${a.currentProjectId}`);a.currentProjectData=o.project||a.currentProjectData,x(a.currentProjectData),u(i.dryRun?`已创建 ${((t=r.generatedAssets)==null?void 0:t.length)||0} 条资产规划。`:`已生成 ${((n=r.generatedAssets)==null?void 0:n.length)||0} 个基准资产。`,"success")}catch(i){u(`基准图生成失败：${i.message}`,"error")}}function lt(){var i,r,o;const e=((i=document.getElementById("preview-style-preset"))==null?void 0:i.value.trim())||"",t=((r=document.getElementById("preview-pacing"))==null?void 0:r.value)||"balanced",n=Number(((o=document.getElementById("preview-adaptation-strength"))==null?void 0:o.value)??.5);return{pacing:t,refinement:{adaptationStrength:Number.isFinite(n)?Math.max(0,Math.min(1,n)):.5},styleProfile:e?{stylePreset:e}:{}}}async function dt(){if(!a.currentProjectId){u("请先导入并保存项目。","error");return}u("正在重算改编结构...","pending");try{const e=Y(),t=await f(`/projects/${a.currentProjectId}/adaptation/rebuild`,y("POST",{gameType:e.gameType,adaptationMode:e.adaptationMode}));a.currentProjectData=t.project||a.currentProjectData,x(a.currentProjectData),u("改编结构已重算。","success")}catch(e){u(`重算失败：${e.message}`,"error")}}async function mt(){if(!a.currentProjectId){u("请先导入并保存项目。","error");return}u("正在重建视觉圣经...","pending");try{const e=lt(),t=await f(`/projects/${a.currentProjectId}/visual-bible/rebuild`,y("POST",{styleProfile:e.styleProfile}));a.currentProjectData=t.project||a.currentProjectData,x(a.currentProjectData),u("视觉圣经已重建。","success")}catch(e){u(`重建失败：${e.message}`,"error")}}async function ut(){if(!a.currentProjectId){u("请先导入并保存项目。","error");return}u("正在应用校正参数...","pending");try{const e=Y(),t=lt(),n=await f(`/projects/${a.currentProjectId}/refine`,y("POST",{...t,adaptationMode:e.adaptationMode}));a.currentProjectData=n.project||a.currentProjectData,x(a.currentProjectData),u("校正参数已应用。","success")}catch(e){u(`应用失败：${e.message}`,"error")}}function Yt(e,t){const n=new Blob([JSON.stringify(t,null,2)],{type:"application/json;charset=utf-8"}),i=URL.createObjectURL(n),r=document.createElement("a");r.href=i,r.download=e,document.body.appendChild(r),r.click(),document.body.removeChild(r),URL.revokeObjectURL(i)}async function pt(){var e;if(!a.currentProjectId){u("请先导入并保存项目。","error");return}u("正在导出项目包...","pending");try{const n=(await f(`/projects/${a.currentProjectId}/export-package`)).package||{},i=`${(((e=a.currentProjectData)==null?void 0:e.title)||"project").replace(/[\\/:*?"<>|]/g,"_")}_package.json`;Yt(i,n),u("项目包导出成功。","success")}catch(t){u(`导出失败：${t.message}`,"error")}}async function se(e={}){if(!a.currentProjectId)return u("当前没有可保存的导入项目，请重新导入。","error"),null;const t=e.showStatus!==!1;t&&u("正在保存导入项目修改...","pending");try{const n=await f(`/projects/${a.currentProjectId}/update`,y("POST",{edits:Y()}));return a.currentProjectData=n.project||a.currentProjectData,a.currentProjectData&&(document.getElementById("import-title").value=a.currentProjectData.title||""),x(a.currentProjectData),t&&u(e.successMessage||"导入项目修改已保存。","success"),a.currentProjectData}catch(n){return console.error("Save imported project edits error:",n),t&&u(n.message,"error"),null}}async function Qt(){var n,i,r,o,s;const e=((n=document.getElementById("import-content"))==null?void 0:n.value.trim())||"";if(!e){h("请先粘贴要导入的长文本内容。","error");return}const t=S(N());a.currentGenerationConfig=t,j(),h("正在解析长文本并创建项目...","pending");try{const m={title:((i=document.getElementById("import-title"))==null?void 0:i.value.trim())||"",content:e,gameType:((r=document.getElementById("import-game-type"))==null?void 0:r.value)||"custom",adaptationMode:((o=document.getElementById("adaptation-mode"))==null?void 0:o.value)||"balanced"},d=await f("/projects/import-text",y("POST",m));a.currentProjectId=((s=d.project)==null?void 0:s.id)||null,a.currentProjectData=d.project||null,a.currentGameType=m.gameType,x(d.project),h("导入成功，请先检查提取结果，再决定是否进入工作台。","success"),u("可以先轻量修改角色、章节和地点，再确认进入工作台。"),await U(),b("import-preview-screen")}catch(m){console.error("Imported project init error:",m),h(m.message,"error")}}async function Xt(){var t,n;if(!a.currentProjectId){h("当前没有可用的导入项目，请重新导入。","error"),b("import-screen");return}const e=S(N());a.currentGenerationConfig=e,j();try{const i=await se({successMessage:"修改已保存，正在进入生成工作台..."});if(!i)return;const r=await f(`/projects/${a.currentProjectId}/init-session`,y("POST",{config:e,gameType:i.gameType||a.currentGameType||"custom",userInput:((t=i.storyBible)==null?void 0:t.summary)||((n=i.source)==null?void 0:n.excerpt)||""}));await ot(r),h("导入项目已进入生成工作台。","success")}catch(i){console.error("Start imported project session error:",i),h(i.message,"error"),u(i.message,"error"),b("import-screen")}}async function U(){const e=document.getElementById("import-project-list");if(e){e.innerHTML='<p class="empty-hint">正在加载项目列表...</p>';try{const t=await f("/projects"),n=Array.isArray(t.projects)?t.projects:[];if(!n.length){e.innerHTML='<p class="empty-hint">还没有导入项目。</p>';return}e.innerHTML=n.map(i=>`
        ...
        `).join(""),e.querySelectorAll('[data-action="open"]').forEach(i=>{i.addEventListener("click",async()=>{const r=i.closest("[data-project-id]"),o=r==null?void 0:r.getAttribute("data-project-id");o&&await Zt(o)})}),e.querySelectorAll('[data-action="delete"]').forEach(i=>{i.addEventListener("click",async()=>{const r=i.closest("[data-project-id]"),o=r==null?void 0:r.getAttribute("data-project-id");o&&await en(o)})})}catch(t){e.innerHTML=`<p class="empty-hint">项目列表加载失败：${l(t.message)}</p>`}}}async function Zt(e){var t,n;try{const i=await f(`/projects/${e}`);a.currentProjectId=((t=i.project)==null?void 0:t.id)||e,a.currentProjectData=i.project||null,a.currentGameType=((n=i.project)==null?void 0:n.gameType)||a.currentGameType,a.currentProjectData&&(document.getElementById("import-title").value=a.currentProjectData.title||"",a.currentGameType=a.currentProjectData.gameType||a.currentGameType),x(a.currentProjectData),h("已加载导入项目，你可以继续修改。","success"),u("项目已加载，可直接修改并继续进入工作台。"),b("import-preview-screen")}catch(i){h(`加载项目失败：${i.message}`,"error")}}async function en(e){if(confirm("确定删除这个导入项目吗？删除后不可恢复。"))try{await f(`/projects/${e}`,y("DELETE",{})),a.currentProjectId===e&&(a.currentProjectId=null,a.currentProjectData=null),await U(),h("项目已删除。","success")}catch(t){h(`删除项目失败：${t.message}`,"error")}}function tn(){document.getElementById("generate-only-btn").addEventListener("click",async()=>{a.currentStepId&&await an(a.currentStepId)}),document.getElementById("regenerate-btn").addEventListener("click",async()=>{await Ye(prompt("请输入重生成补充要求（可留空）：")||"")}),document.getElementById("modify-btn").addEventListener("click",()=>{document.getElementById("custom-input-area").style.display="block",document.getElementById("custom-feedback").focus()}),document.getElementById("apply-custom-btn").addEventListener("click",async()=>{const e=document.getElementById("custom-feedback").value.trim();e&&(await Ye(e),document.getElementById("custom-feedback").value="",document.getElementById("custom-input-area").style.display="none")}),document.getElementById("confirm-btn").addEventListener("click",async()=>{await ln()}),document.getElementById("skip-btn").addEventListener("click",async()=>{await dn()}),document.getElementById("gen-finalize-btn").addEventListener("click",async()=>{await fn()})}function H(){const e=document.getElementById("step-navigation");e.innerHTML="",a.allSteps.forEach(t=>{const n=L(t.id),i=M[t.id]||{icon:"?",name:t.name||t.id},r=document.createElement("button");r.type="button",r.className="step",t.id===a.currentStepId&&r.classList.add("active"),n.status==="confirmed"&&r.classList.add("completed"),n.status==="loading"&&r.classList.add("generating"),r.innerHTML=`<span class="step-icon">${i.icon}</span><span class="step-label">${t.name||i.name}</span>`,r.addEventListener("click",async()=>{await nn(t.id)}),e.appendChild(r)})}async function nn(e,t){a.currentStepId=e,H(),L(e);{A(e);return}}function A(e){const t=M[e]||{name:e,desc:""},n=L(e);document.getElementById("current-step-name").textContent=t.name,document.getElementById("current-step-desc").textContent=t.desc,document.getElementById("step-loading").style.display=n.status==="loading"?"flex":"none",document.getElementById("action-buttons").style.display="flex",ft(e),gt(),Q(e)}async function an(e){var n;const t=L(e);t.status="loading",A(e),w("calling",`正在生成 ${((n=M[e])==null?void 0:n.name)||e}...`);try{const i=await f("/generate/step",y("POST",{sessionId:a.currentSessionId,stepId:e,options:{candidateCount:2}}));t.candidates=i.candidates||[],t.selectedIndex=-1,t.status="generated",t.history.push({id:Date.now(),timestamp:new Date,candidates:t.candidates.map(r=>structuredClone(r))}),w("success",`已生成 ${t.candidates.length} 个候选方案。`)}catch(i){console.error("Load step error:",i),t.status="error",w("error",i.message)}A(e)}function ft(e){const t=document.getElementById("candidates-container"),n=L(e);if(t.innerHTML="",n.status!=="loading"){if(!n.candidates.length){t.innerHTML='<div class="candidate-card"><div class="candidate-empty">当前步骤还没有生成内容。点击下方“生成”开始。</div></div>';return}n.candidates.forEach((i,r)=>{const o=document.createElement("button");o.type="button",o.className="candidate-card",n.selectedIndex===r&&o.classList.add("selected"),o.innerHTML=`
            <div class="candidate-card-header">
                <strong>${l(rn(e,i,r))}</strong>
                <span>方案 ${r+1}</span>
            </div>
            <div class="candidate-card-content">${on(e,i)}</div>
        `,o.addEventListener("click",()=>{n.selectedIndex=r,ft(e),Q(e)}),t.appendChild(o)})}}function Q(e){const t=L(e),n=t.candidates.length>0;document.getElementById("confirm-btn").disabled=t.selectedIndex<0,document.getElementById("regenerate-btn").disabled=!n,document.getElementById("modify-btn").disabled=!n,document.getElementById("gen-finalize-btn").style.display=a.allSteps.every(i=>L(i.id).status==="confirmed")?"inline-block":"none"}function rn(e,t,n){var i,r;return e==="worldview"?t.worldName||`世界观方案 ${n+1}`:e==="mainPlot"?t.title||`主线方案 ${n+1}`:e==="integration"?t.gameName||`整合方案 ${n+1}`:Array.isArray(t)?`${((i=M[e])==null?void 0:i.name)||e} · ${t.length} 项`:t.name||t.title||`${((r=M[e])==null?void 0:r.name)||e} 方案 ${n+1}`}function on(e,t){var n,i,r,o,s,m;if(t!=null&&t.error)return $("解析提示",t.error||"AI 响应暂时无法解析，请尝试重新生成。");if(typeof t=="string")return $("方案内容",t);switch(e){case"worldview":return[O("世界名称",t.worldName),O("时代背景",t.era),$("世界描述",t.description),Ve("世界规则",t.rules),Ke("主要势力",t.factions,["name","description"]),Ke("重要地点",t.locations,["name","description"])].join("");case"mainPlot":return[O("主线标题",t.title),O("核心主题",t.theme),$("剧情概览",t.summary),$("引发事件",t.incitingIncident),sn("章节结构",(t.chapters||[]).map(d=>({title:d.name||d.title,body:`${d.goal||""}${d.description?`：${d.description}`:""}`}))),$("高潮",t.climax),$("结局说明",t.resolution)].join("");case"integration":return[O("游戏名称",t.gameName),$("玩法设计",t.gameplayDesign),O("战斗类型",(i=(n=t.gameSystems)==null?void 0:n.combatSystem)==null?void 0:i.type),Ve("战斗机制",(o=(r=t.gameSystems)==null?void 0:r.combatSystem)==null?void 0:o.mechanics),$("开场场景",(s=t.openingScene)==null?void 0:s.description),$("开场旁白",(m=t.openingScene)==null?void 0:m.narration),$("平衡性说明",t.balancingNotes)].join("");default:return cn(t,e)}}function cn(e,t){const n=Array.isArray(e)?e:e?[e]:[];return n.length?n.map((i,r)=>{var d;const o=i.name||i.title||`${((d=M[t])==null?void 0:d.name)||"条目"} ${r+1}`,s=i.description||i.summary||i.role||i.type||"",m=[i.role?`<span class="candidate-chip">${l(i.role)}</span>`:"",i.location?`<span class="candidate-chip">${l(i.location)}</span>`:"",i.type?`<span class="candidate-chip">${l(i.type)}</span>`:"",i.rarity?`<span class="candidate-chip">${l(i.rarity)}</span>`:""].join("");return`
            <div class="candidate-item">
                <div class="candidate-item-title">${l(o)}</div>
                ${m?`<div class="candidate-chip-row">${m}</div>`:""}
                ${s?`<div class="candidate-item-body">${l(s)}</div>`:""}
            </div>
        `}).join(""):'<div class="candidate-empty">当前方案没有可展示的条目。</div>'}function O(e,t){return t?`<div class="candidate-field"><span class="candidate-label">${l(e)}</span><span class="candidate-value">${l(t)}</span></div>`:""}function $(e,t){return t?`
        <div class="candidate-block">
...
`,"<br>")}</div>
    ...
    `}function Ke(e,t,n){return!Array.isArray(t)||!t.length?"":`
        <div class="candidate-block">
            ...
            ${t.map(i=>`
                <div class="candidate-item">
                    <div class="candidate-item-title">${l(i[n[0]]||"未命名")}</div>
                    ${i[n[1]]?`<div class="candidate-item-body">${l(i[n[1]])}</div>`:""}
                </div>
            `).join("")}
        </div>
    ...
    `}async function Ye(e){var n;if(!a.currentStepId)return;const t=L(a.currentStepId);t.status="loading",A(a.currentStepId),w("calling",`正在重新生成 ${((n=M[a.currentStepId])==null?void 0:n.name)||a.currentStepId}...`);try{const i=await f("/generate/regenerate",y("POST",{sessionId:a.currentSessionId,stepId:a.currentStepId,feedback:e}));t.candidates=i.candidates||[],t.selectedIndex=-1,t.status="generated",t.history.push({id:Date.now(),timestamp:new Date,candidates:t.candidates.map(r=>structuredClone(r))}),w("success","已完成重新生成。")}catch(i){console.error("Regenerate error:",i),t.status="error",w("error",i.message)}A(a.currentStepId)}async function ln(){const e=L(a.currentStepId),t=e.candidates[e.selectedIndex];if(t)try{const n=await f("/generate/confirm",y("POST",{sessionId:a.currentSessionId,stepId:a.currentStepId,candidate:t}));e.status="confirmed",await le(),H(),n.nextStep?(a.currentStepId=n.nextStep,H(),A(n.nextStep),w("success","已确认当前步骤。下一步不会自动生成，请按需点击“生成”。")):(w("success","所有步骤都已确认，可以整合生成游戏了。"),Q(a.currentStepId))}catch(n){console.error("Confirm step error:",n),alert(`确认失败：${n.message}`)}}async function dn(){try{const e=await f("/generate/confirm",y("POST",{sessionId:a.currentSessionId,stepId:a.currentStepId,candidate:{skipped:!0}}));L(a.currentStepId).status="confirmed",await le(),H(),e.nextStep?(a.currentStepId=e.nextStep,H(),A(e.nextStep)):Q(a.currentStepId)}catch(e){console.error("Skip step error:",e),alert(`跳过失败：${e.message}`)}}async function le(){var t,n,i,r,o,s,m;const e=document.getElementById("confirmed-elements");try{const c=(await f(`/generate/${a.currentSessionId}/status`)).memory||{},p=[];c.worldview&&p.push(C("世界观",c.worldview.worldName||"已确认")),(t=c.coreCharacters)!=null&&t.length&&p.push(C("核心角色",`${c.coreCharacters.length} 名`)),(n=c.secondaryCharacters)!=null&&n.length&&p.push(C("次要角色",`${c.secondaryCharacters.length} 名`)),(i=c.items)!=null&&i.length&&p.push(C("物品道具",`${c.items.length} 项`)),(r=c.puzzles)!=null&&r.length&&p.push(C("谜题挑战",`${c.puzzles.length} 项`)),c.mainPlot&&p.push(C("主线剧情",c.mainPlot.title||"已确认")),(o=c.sidePlots)!=null&&o.length&&p.push(C("支线剧情",`${c.sidePlots.length} 条`)),(s=c.fragments)!=null&&s.length&&p.push(C("碎片内容",`${c.fragments.length} 条`)),(m=c.integration)!=null&&m.gameName&&p.push(C("整合方案",c.integration.gameName)),e.innerHTML=p.join("")||'<p class="empty-hint">尚未确认任何内容。</p>'}catch(d){console.error("Render confirmed elements error:",d),e.innerHTML='<p class="empty-hint">获取已确认内容失败。</p>'}}function C(e,t){return`<div class="confirmed-item"><span class="confirmed-label">${e}</span><span class="confirmed-value">${t}</span></div>`}function gt(){const e=document.getElementById("history-panel");if(!e)return;const t=[];for(const n of a.allSteps){const i=L(n.id);if(!i.history.length)continue;const r=i.history.slice().reverse().map(o=>`<div class="history-entry">${n.name||n.id} · ${o.timestamp.toLocaleTimeString()}</div>`).join("");t.push(`<div class="history-step">${r}</div>`)}e.innerHTML=t.join("")||'<p class="empty-hint">暂无生成记录。</p>'}function I(){if(a.currentGenerationConfig)return S(a.currentGenerationConfig);const e=S(N());return a.currentGenerationConfig=e,e}function _(e,t,n=""){const i=document.getElementById("game-log");if(!i||!t)return;const r=document.createElement("div");if(r.className=`log-entry ${e}`,n){const s=document.createElement("div");s.className="speaker",s.textContent=n,r.appendChild(s)}const o=document.createElement("div");o.className="content",o.textContent=t,r.appendChild(o),i.appendChild(r),i.scrollTop=i.scrollHeight}function de(e=[]){const t=document.getElementById("choices-container");if(t){if(!Array.isArray(e)||!e.length){t.innerHTML="";return}t.innerHTML=e.map((n,i)=>`
        <button type="button" class="choice-btn" data-choice-index="${i}">
            ${l(n.text||n.action||`选项 ${i+1}`)}
        </button>
    `).join(""),t.querySelectorAll("[data-choice-index]").forEach(n=>{n.addEventListener("click",async()=>{const i=Number(n.getAttribute("data-choice-index")),r=e[i];r&&await re(r.action||r.text||"")})})}}function mn(e={}){const t=document.getElementById("player-stats");if(!t)return;const n=Object.entries(e||{});if(!n.length){t.innerHTML='<p class="empty-hint">暂无属性信息</p>';return}t.innerHTML=n.map(([i,r])=>{if(r&&typeof r=="object"&&Number.isFinite(r.current)&&Number.isFinite(r.max)){const o=r.max>0?Math.max(0,Math.min(100,r.current/r.max*100)):0;return`
                <div class="stat-item">
                    <div style="width:100%">
                        <span class="stat-name">${l(i)}</span>
            ...
            <div class="stat-item">
                <span class="stat-name">${l(i)}</span>
                <span class="stat-value">${l(String(r))}</span>
            </div>
        `}).join("")}function un(e=[]){const t=document.getElementById("inventory-list");if(t){if(!Array.isArray(e)||!e.length){t.innerHTML="<li>暂无物品</li>";return}t.innerHTML=e.map(n=>`<li>${l(n.name||String(n))}</li>`).join("")}}function pn(e=[]){const t=document.getElementById("quest-list");if(t){if(!Array.isArray(e)||!e.length){t.innerHTML="<li>暂无任务</li>";return}t.innerHTML=e.map(n=>`
        <li class="${n.completed?"completed":""}">
            ${l(n.name||n.description||"未命名任务")}
            ${n.progress?` · ${l(n.progress)}`:""}
        </li>
    `).join("")}}async function yt(e=a.currentGameId){if(e)try{const t=await f(`/games/${e}/start`,y("POST",{}));a.currentGameId=e,a.gameState=t.gameState||null,a.sceneImages=[],a.selectedSceneImageIndex=0,a.activeSceneImage="",a.transitioningSceneImage="",a.currentVisualSignature="",document.getElementById("game-log").innerHTML="",de([]),W([]),b("game-screen"),X(a.gameState)}catch(t){alert(`启动游戏失败：${t.message}`)}}async function fn(){var e;if(!a.currentSessionId){alert("当前没有生成会话。");return}w("calling","正在整合并生成最终游戏...");try{const t=await f(`/generate/${a.currentSessionId}/finalize`,y("POST",{config:I()}));a.currentGameId=t.gameId,a.currentGameData=t.gameData||null,a.currentGameType=((e=t.gameData)==null?void 0:e.type)||a.currentGameType,await yt(a.currentGameId),w("success","游戏已生成并启动。")}catch(t){w("error",t.message),alert(`整合失败：${t.message}`)}}async function re(e=""){var r,o;if(!a.currentGameId)return;const t=document.getElementById("player-input"),n=document.getElementById("send-btn"),i=e||(t==null?void 0:t.value.trim())||"";if(i){t&&(t.value=""),n&&(n.disabled=!0),_("player",i,"你");try{const s=I(),m=s.imageSource==="comfyui"?{...s,...K()}:s,d=await f(`/games/${a.currentGameId}/action`,y("POST",{action:i,imageConfig:m}));Array.isArray((r=d.gameState)==null?void 0:r.lastDialogues)&&d.gameState.lastDialogues.forEach(c=>{c!=null&&c.content&&_("narrator",c.content,c.speaker||"角色")}),d.response&&_("narrator",d.response),d.gameOver&&d.gameOverMessage&&_("system",d.gameOverMessage),de(d.choices||[]),X(d.gameState||a.gameState),d.sceneImage&&W([d.sceneImage],((o=d.visualState)==null?void 0:o.prompt)||d.sceneDescription||d.response)}catch(s){_("system",`行动处理失败：${s.message}`)}finally{n&&(n.disabled=!1)}}}function gn(){var e,t,n,i,r,o,s,m,d;xt(),document.getElementById("send-btn").addEventListener("click",re),document.getElementById("player-input").addEventListener("keydown",c=>{c.key==="Enter"&&re()}),(e=document.getElementById("generate-scene-image-btn"))==null||e.addEventListener("click",async()=>{await yn()}),(t=document.getElementById("scene-image-count"))==null||t.addEventListener("change",()=>{const c=document.getElementById("scene-image-count"),p=document.getElementById("comfyui-image-count"),g=String(Math.max(1,Math.min(8,Number(c.value)||1)));c.value=g,p&&(p.value=g),j()}),(n=document.getElementById("live-comfyui-workflow-mode"))==null||n.addEventListener("change",()=>{Ct(),syncLiveImageConfigState()}),(i=document.getElementById("live-refresh-comfyui-btn"))==null||i.addEventListener("click",async()=>{await refreshLiveComfyUIOptions(!0)}),(r=document.getElementById("live-refresh-workflow-files-btn"))==null||r.addEventListener("click",async()=>{await refreshLiveComfyWorkflowFiles(!0)}),(o=document.getElementById("live-load-workflow-btn"))==null||o.addEventListener("click",async()=>{await loadSelectedLiveWorkflowFile(!0)}),(s=document.getElementById("live-test-comfyui-btn"))==null||s.addEventListener("click",async()=>{await testLiveComfyUIConnection()}),(m=document.getElementById("live-validate-workflow-btn"))==null||m.addEventListener("click",async()=>{await validateLiveComfyUIWorkflow()}),(d=document.getElementById("live-comfyui-workflow-file"))==null||d.addEventListener("change",()=>{syncLiveImageConfigState()}),document.querySelectorAll("#live-image-config input, #live-image-config select, #live-image-config textarea").forEach(c=>{c.addEventListener("change",()=>{syncLiveImageConfigState()})}),document.getElementById("game-menu-btn").addEventListener("click",()=>{document.getElementById("game-menu-modal").classList.add("active")}),document.getElementById("save-game").addEventListener("click",async()=>{var c,p;if(a.gameState&&a.currentGameId)try{const g=await f(`/games/${a.currentGameId}`),v=Je(a.currentGameId,g.state||a.gameState,{gameData:g.game||a.currentGameData,generationConfig:I(),type:a.currentGameType||((c=g.game)==null?void 0:c.type)||((p=a.gameState)==null?void 0:p.type)||"custom"});a.currentGameData=g.game||a.currentGameData,localStorage.setItem(`rpg_save_${a.currentGameId}`,JSON.stringify(v)),alert("游戏进度已保存。")}catch(g){console.error("Save game error:",g);const v=Je(a.currentGameId,a.gameState,{generationConfig:I()});localStorage.setItem(`rpg_save_${a.currentGameId}`,JSON.stringify(v)),alert("游戏进度已保存，但这次没有拿到完整后端快照。若服务重启后要续玩，建议重新保存一次。")}document.getElementById("game-menu-modal").classList.remove("active")}),document.getElementById("load-game").addEventListener("click",async()=>{if(!a.currentGameId){document.getElementById("game-menu-modal").classList.remove("active");return}ce(`rpg_save_${a.currentGameId}`)?await rt(a.currentGameId):alert("没有找到存档。"),document.getElementById("game-menu-modal").classList.remove("active")}),document.getElementById("restart-game").addEventListener("click",async()=>{a.currentGameId&&await yt(a.currentGameId),document.getElementById("game-menu-modal").classList.remove("active")}),q(),syncLiveImageConfigPanel()}async function yn(){var s,m;if(!a.currentGameId){G("Start the game before generating images.","error");return}const e=document.getElementById("scene-image-prompt"),t=document.getElementById("scene-image-count"),n=document.getElementById("comfyui-image-count"),i=(e==null?void 0:e.value.trim())||((s=a.gameState)==null?void 0:s.sceneDescription)||((m=a.gameState)==null?void 0:m.initialLog)||"",r=Math.max(1,Math.min(8,Number(t==null?void 0:t.value)||1));if(!i){G("No scene prompt available yet.","error");return}t&&(t.value=String(r)),n&&(n.value=String(r));const o=I().imageSource==="comfyui"?{...I(),...K(),comfyuiImageCount:r}:{...I(),comfyuiImageCount:r};a.currentGenerationConfig=o,localStorage.setItem(V,JSON.stringify(o)),Qe(!0),G("Generating images with ComfyUI...","pending");try{const d=await f(`/games/${a.currentGameId}/generate-image`,y("POST",{prompt:i,count:r,comfyuiImageCount:r,...o}));a.selectedSceneImageIndex=0,W(d.images||[],d.prompt||i),G(`Generated ${d.count||(d.images||[]).length} image(s).`,"success")}catch(d){console.error("Generate scene image error:",d),G(d.message,"error")}finally{Qe(!1)}}function G(e,t=""){const n=document.getElementById("scene-image-status");n&&(n.textContent=e,n.className=`helper-text ${t}`.trim())}function Qe(e){const t=document.getElementById("generate-scene-image-btn");t&&(t.disabled=!!e,t.textContent=e?"生成中...":"生成场景图")}function q(){var s,m;const e=document.getElementById("scene-image-controls"),t=document.getElementById("scene-image-prompt"),n=document.getElementById("scene-image-count"),i=document.getElementById("live-image-config"),r=I(),o=r.enableImages&&r.imageSource!=="none";if(e&&(e.style.display=o?"block":"none"),!o){G("当前未启用图像生成。","pending");return}if(t){const d=a.lastSuggestedImagePrompt||((s=a.gameState)==null?void 0:s.sceneDescription)||((m=a.gameState)==null?void 0:m.initialLog)||"";(!t.value.trim()||t.value===a.lastSuggestedImagePrompt)&&(t.value=d),a.lastSuggestedImagePrompt=d}n&&(n.value=String(Math.max(1,Math.min(8,Number(r.comfyuiImageCount)||1)))),i&&(i.style.display=r.imageSource==="comfyui"?"block":"none"),r.imageGenerationMode==="auto"?G("当前为自动生图模式：视觉场景变化时会自动更新。","pending"):G("当前为手动生图模式：点击按钮后才会生成。","pending")}function W(e=[],t=""){a.sceneImages=Array.isArray(e)?e:[],a.selectedSceneImageIndex=0,t&&(a.lastSuggestedImagePrompt=t);const n=document.getElementById("scene-image-gallery");n&&(a.sceneImages.length?(n.innerHTML=a.sceneImages.map((r,o)=>`
                    <button
                        type="button"
                ...
                `).join(""),n.querySelectorAll("[data-scene-thumb]").forEach(r=>{r.addEventListener("click",()=>{const o=Number(r.getAttribute("data-scene-thumb"));Number.isNaN(o)||(a.selectedSceneImageIndex=o,Xe(a.sceneImages[o]||""),n.querySelectorAll("[data-scene-thumb]").forEach(s=>{s.classList.toggle("active",Number(s.getAttribute("data-scene-thumb"))===o)}))})})):n.innerHTML=""),Xe(a.sceneImages[a.selectedSceneImageIndex]||"");const i=document.getElementById("scene-image-prompt");i&&a.lastSuggestedImagePrompt&&!i.value.trim()&&(i.value=a.lastSuggestedImagePrompt)}function Xe(e=""){const t=document.getElementById("scene-image");if(!t)return;if(!e){a.activeSceneImage="",a.transitioningSceneImage="",t.innerHTML='<div class="placeholder">场景图像将在这里显示</div>';return}if(!a.activeSceneImage){a.activeSceneImage=e,a.transitioningSceneImage="",t.innerHTML=`
        ...
        `)},i.src=e}function vn(e=a.gameState){return e?{chapterId:e.currentChapter??null,sceneNodeId:e.currentScene||null,plotBeatId:e.turn??null,playerState:e.player||{},worldState:e.worldState||{},relationshipState:e.characterStates||[],inventory:e.inventory||[],activeQuests:(e.quests||[]).filter(t=>t&&t.completed!==!0),visualState:e.visualState||null,history:(e.history||[]).slice(-20)}:null}function bn(){!a.currentProjectId||!a.gameState||a.runtimeSnapshotSaving||(a.runtimeSnapshotTimer&&window.clearTimeout(a.runtimeSnapshotTimer),a.runtimeSnapshotTimer=window.setTimeout(async()=>{a.runtimeSnapshotSaving=!0;try{await f(`/projects/${a.currentProjectId}/runtime-snapshot`,y("POST",{runtimeSnapshot:vn(a.gameState)}))}catch(e){console.warn("Runtime snapshot save failed:",e.message)}finally{a.runtimeSnapshotSaving=!1}},800))}function X(e=a.gameState){var n,i;if(!e)return;a.gameState=e,a.currentVisualSignature=((n=e.visualState)==null?void 0:n.signature)||a.currentVisualSignature,document.getElementById("game-title").textContent=e.name||"AI 生成 RPG",document.getElementById("scene-description").textContent=e.sceneDescription||"";const t=document.getElementById("game-log");e.initialLog&&!t.children.length&&_("narrator",e.initialLog),mn(((i=e.player)==null?void 0:i.stats)||{}),un(e.inventory||[]),pn(e.quests||[]),q(),bn()}async function J(e){const t=document.getElementById(`test-${e}-result`),n=document.getElementById(`test-${e}-btn`);n.disabled=!0,t.textContent="测试中...",t.className="test-result";try{const i=await f("/test-connection",y("POST",oe(e)));t.textContent=i.success?"连接成功":i.error||"连接失败",t.className=`test-result ${i.success?"success":"error"}`}catch(i){t.textContent=i.message,t.className="test-result error"}finally{n.disabled=!1}}function P(e){return l(e).replaceAll('"',"&quot;").replaceAll("'","&#39;")}function l(e){return String(e).replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;")}
