(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const r of document.querySelectorAll('link[rel="modulepreload"]'))i(r);new MutationObserver(r=>{for(const o of r)if(o.type==="childList")for(const s of o.addedNodes)s.tagName==="LINK"&&s.rel==="modulepreload"&&i(s)}).observe(document,{childList:!0,subtree:!0});function n(r){const o={};return r.integrity&&(o.integrity=r.integrity),r.referrerPolicy&&(o.referrerPolicy=r.referrerPolicy),r.crossOrigin==="use-credentials"?o.credentials="include":r.crossOrigin==="anonymous"?o.credentials="omit":o.credentials="same-origin",o}function i(r){if(r.ep)return;r.ep=!0;const o=n(r);fetch(r.href,o)}})();const nt=`${window.location.origin}/api`,at=window.localStorage.getItem("rpg_generator_api_base")||"",it=(at||nt).replace(/\/$/,"");async function rt(e){try{const t=await e.json();return(t==null?void 0:t.error)||(t==null?void 0:t.message)||`${e.status} ${e.statusText}`}catch{return`${e.status} ${e.statusText}`}}async function f(e,t={}){const n=await fetch(`${it}${e}`,t);if(!n.ok)throw new Error(await rt(n));return n.json()}function y(e,t){return{method:e,headers:{"Content-Type":"application/json"},body:JSON.stringify(t)}}const De={openai:{apiUrl:{id:"openai-url",fallback:"https://api.openai.com/v1"},apiKey:{id:"openai-key"},model:{id:"openai-model",fallback:"gpt-4o"}},anthropic:{apiKey:{id:"anthropic-key"},model:{id:"anthropic-model",fallback:"claude-3-5-sonnet-20241022"}},local:{apiUrl:{id:"ollama-url",fallback:"http://localhost:11434"},model:{id:"ollama-model",fallback:"llama3"}},custom:{apiUrl:{id:"custom-url"},apiKey:{id:"custom-key"},model:{id:"custom-model"}}},Me={difficulty:{id:"game-difficulty",fallback:"normal"},length:{id:"game-length",fallback:"medium"},enableImages:{id:"enable-images",type:"checkbox",fallback:!0},imageSource:{id:"image-source",fallback:"comfyui"},imageGenerationMode:{id:"image-generation-mode",fallback:"manual"},comfyuiUrl:{id:"comfyui-url",fallback:"http://127.0.0.1:8000"},comfyuiImageCount:{id:"comfyui-image-count",fallback:"1"},comfyuiModel:{id:"comfyui-model",fallback:""},comfyuiSampler:{id:"comfyui-sampler",fallback:"euler"},comfyuiScheduler:{id:"comfyui-scheduler",fallback:"normal"},comfyuiWidth:{id:"comfyui-width",fallback:"768"},comfyuiHeight:{id:"comfyui-height",fallback:"512"},comfyuiSteps:{id:"comfyui-steps",fallback:"20"},comfyuiCfg:{id:"comfyui-cfg",fallback:"7.5"},comfyuiSeed:{id:"comfyui-seed",fallback:"-1"},comfyuiTimeoutMs:{id:"comfyui-timeout-ms",fallback:"180000"},comfyuiPromptPrefix:{id:"comfyui-prompt-prefix",fallback:"RPG game scene"},comfyuiPromptSuffix:{id:"comfyui-prompt-suffix",fallback:"high quality, detailed, fantasy art style"},comfyuiNegativePrompt:{id:"comfyui-negative-prompt",fallback:"low quality, blurry, deformed, ugly, bad anatomy, watermark, text"},comfyuiFilenamePrefix:{id:"comfyui-filename-prefix",fallback:"rpg_scene"},comfyuiWorkflowMode:{id:"comfyui-workflow-mode",fallback:"custom"},comfyuiWorkflowFile:{id:"comfyui-workflow-file",fallback:""},comfyuiWorkflowJson:{id:"comfyui-workflow-json",fallback:""},imageApiUrl:{id:"image-api-url",fallback:""},imageApiKey:{id:"image-api-key",fallback:""}};function ot(e,t){var n;return((n=t.getElementById(e))==null?void 0:n.value)||""}function ct(e,t){const n=t.getElementById(e.id);return n?e.type==="checkbox"?n.checked:n.value||e.fallback||"":e.fallback}function st(e,t,n){const i=n.getElementById(e);i&&t!==void 0&&(i.value=t)}function lt(e,t,n){const i=n.getElementById(e.id);if(!(!i||t===void 0)){if(e.type==="checkbox"){i.checked=!!t;return}i.value=t}}function ae(e=null,t=document){const n=e||t.getElementById("llm-source").value,i=De[n]||{},r={llmSource:n};for(const[o,s]of Object.entries(i))r[o]=ot(s.id,t)||s.fallback||"";return r}function dt(e,t=document){const n=e.llmSource||"openai";t.getElementById("llm-source").value=n,t.getElementById("llm-source").dispatchEvent(new Event("change"));const i=De[n]||{};for(const[r,o]of Object.entries(i))st(o.id,e[r]||o.fallback||"",t)}function D(e=document){const t={settings:ae(null,e)};for(const[n,i]of Object.entries(Me))t[n]=ct(i,e);return t}function Pe(e={},t=document){for(const[n,i]of Object.entries(Me))lt(i,e[n]??i.fallback,t)}const a={currentGameType:null,currentProjectId:null,currentProjectData:null,currentGameId:null,currentGameData:null,gameState:null,currentGenerationConfig:null,currentSessionId:null,currentStepId:null,allSteps:[],stepStates:{},sceneImages:[],selectedSceneImageIndex:0,lastSuggestedImagePrompt:"",activeSceneImage:"",transitioningSceneImage:"",currentVisualSignature:"",sceneImageTransitionToken:0,runtimeSnapshotTimer:null,runtimeSnapshotSaving:!1},Ne="rpg_generator_settings",z="rpg_generator_generation_settings",Oe={adventure:"冒险 RPG",dungeon:"地牢探索",romance:"恋爱模拟",mystery:"推理解谜",fantasy:"奇幻魔法",scifi:"科幻星际",survival:"生存挑战",kingdom:"王国建设",cultivation:"修仙问道",custom:"自定义 RPG"},A={worldview:{icon:"世",name:"世界观",desc:"先确定世界背景、主要势力、地点与规则。"},coreCharacters:{icon:"核",name:"核心角色",desc:"生成推动主线的关键角色。"},secondaryCharacters:{icon:"辅",name:"次要角色",desc:"补充世界细节与互动节点。"},items:{icon:"物",name:"物品道具",desc:"生成装备、任务物品和关键奖励。"},puzzles:{icon:"谜",name:"谜题挑战",desc:"设计挑战、机关和探索障碍。"},mainPlot:{icon:"主",name:"主线剧情",desc:"组织章节推进与核心冲突。"},sidePlots:{icon:"支",name:"支线剧情",desc:"补充可选故事和人物支线。"},fragments:{icon:"碎",name:"碎片内容",desc:"生成可探索的世界细节与传闻。"},integration:{icon:"整",name:"整合方案",desc:"把已确认内容整合成最终可玩的方案。"}};document.addEventListener("DOMContentLoaded",()=>{ft(),gt(),yt(),wt(),It(),kt(),Nt(),Yt(),He()});function L(e){return a.stepStates[e]||(a.stepStates[e]={candidates:[],selectedIndex:-1,status:"idle",history:[]}),a.stepStates[e]}function b(e){var t;document.querySelectorAll(".screen").forEach(n=>n.classList.remove("active")),(t=document.getElementById(e))==null||t.classList.add("active")}function w(e,t){const n=document.getElementById("api-status-dot"),i=document.getElementById("api-status-text");n&&(n.className="status-dot",n.classList.add(`status-${e}`)),i&&(i.textContent=t)}function Z(){const e=document.getElementById("image-source").value;document.getElementById("comfyui-settings").style.display=e==="comfyui"?"block":"none",document.getElementById("api-settings").style.display=e==="api"?"block":"none",_e()}function mt(){const e=document.getElementById("comfyui-settings");!e||e.dataset.enhanced==="true"||(e.innerHTML=`
    ...
    `,e.dataset.enhanced="true")}function ut(){const e=document.getElementById("live-image-config");!e||e.dataset.enhanced==="true"||(e.innerHTML=`
    ...
    `).join(""),e.querySelectorAll("[data-saved-game-id]").forEach(n=>{n.addEventListener("click",async()=>{await Re(n.dataset.savedGameId)})})}async function Re(e){const t=re(`rpg_save_${e}`);if(!(t!=null&&t.gameState)){alert("没有找到可读取的存档。");return}let n=!1;try{const r=await f(`/games/${t.gameId}`);a.currentGameData=r.game||t.gameData||null,n=!0}catch{if(t.gameData&&t.generationConfig)try{const o=await f("/games/restore",y("POST",{gameId:t.gameId,gameData:t.gameData,gameState:t.gameState,config:I(t.generationConfig)}));t.gameId=o.gameId||t.gameId,t.gameState=o.gameState||t.gameState,a.currentGameData=t.gameData,n=!0}catch(o){console.error("Restore saved game error:",o)}}a.currentGameId=t.gameId,a.currentGameType=t.type||a.currentGameType,a.gameState=t.gameState,a.sceneImages=[],a.selectedSceneImageIndex=0,t.generationConfig&&(a.currentGenerationConfig=I(t.generationConfig),localStorage.setItem(z,JSON.stringify(a.currentGenerationConfig))),b("game-screen"),ce(t.gameState),Y([]),n||alert("这个存档已载入画面，但后端运行态未成功恢复。请重新开始后再保存一次，之后即可正常续玩。");const i=document.getElementById("saved-games-section");i&&(i.style.display="none")}function wt(){document.getElementById("game-config-form").addEventListener("submit",async e=>{if(e.preventDefault(),!a.currentGameType){alert("请先选择一个游戏类型。"),b("home-screen");return}await St()})}function It(){var e,t,n;(e=document.getElementById("import-project-form"))==null||e.addEventListener("submit",async i=>{i.preventDefault(),await Gt()}),(t=document.getElementById("import-package-btn"))==null||t.addEventListener("click",async()=>{await Et()}),(n=document.getElementById("refresh-import-projects"))==null||n.addEventListener("click",async()=>{await q()}),q().catch(i=>{console.error("Load imported projects error:",i)})}async function Et(){var n,i,r;const e=document.getElementById("import-package-file"),t=(n=e==null?void 0:e.files)==null?void 0:n[0];if(!t){h("请先选择一个项目包 JSON 文件。","error");return}h("正在解析并导入项目包...","pending");try{const o=await t.text(),s=JSON.parse(o),m=await f("/projects/import-package",y("POST",{package:s}));a.currentProjectId=((i=m.project)==null?void 0:i.id)||null,a.currentProjectData=m.project||null,a.currentGameType=((r=m.project)==null?void 0:r.gameType)||a.currentGameType||"custom",a.currentProjectData&&(document.getElementById("import-title").value=a.currentProjectData.title||""),j(a.currentProjectData),await q(),b("import-preview-screen"),h("项目包导入成功。","success"),p("项目包已恢复，可以继续调整后进入工作台。","success")}catch(o){h(`导入失败：${o.message}`,"error")}}function h(e,t=""){const n=document.getElementById("import-status");n&&(n.textContent=e,n.className=`helper-text ${t}`.trim())}async function Fe(e){var t;a.currentSessionId=e.sessionId,a.allSteps=e.steps||[],a.currentStepId=e.firstStep||((t=a.allSteps[0])==null?void 0:t.id)||null,a.stepStates={},b("generation-workbench"),O(),await oe(),T(a.currentStepId),Qe(),w("idle","已创建生成会话，点击“生成”开始当前步骤。")}async function St(){const e=I(D());a.currentGenerationConfig=e,P();const t={userInput:document.getElementById("game-description").value.trim()||"暂无额外描述",gameType:a.currentGameType,config:e};try{const n=await f("/generate/init",y("POST",t));a.currentProjectId=null,a.currentProjectData=null,await Fe(n);return}catch(n){console.error("Session init error:",n),alert(`初始化失败：${n.message}`),b("config-screen")}}function kt(){var e,t,n,i,r,o,s;(e=document.getElementById("save-import-preview"))==null||e.addEventListener("click",async()=>{await Ke()}),(t=document.getElementById("generate-base-assets"))==null||t.addEventListener("click",async()=>{await Ue()}),(n=document.getElementById("rebuild-adaptation-btn"))==null||n.addEventListener("click",async()=>{await We()}),(i=document.getElementById("rebuild-visual-bible-btn"))==null||i.addEventListener("click",async()=>{await Je()}),(r=document.getElementById("apply-project-refinement-btn"))==null||r.addEventListener("click",async()=>{await ze()}),(o=document.getElementById("export-project-package-btn"))==null||o.addEventListener("click",async()=>{await Ve()}),(s=document.getElementById("import-preview-screen"))==null||s.addEventListener("click",m=>{const l=m.target.closest("[data-preview-action]");l&&jt(l.dataset.previewAction,l)})}function p(e,t=""){const n=document.getElementById("import-preview-status");n&&(n.textContent=e,n.className=`helper-text ${t}`.trim())}function Bt(e){return JSON.parse(JSON.stringify(e||{}))}function $t(e=0){return{id:`draft_char_${Date.now()}_${e}`,name:"",role:"",description:""}}function Lt(e=0){return{id:`draft_chapter_${Date.now()}_${e}`,title:`新章节 ${e+1}`,summary:""}}function Pt(e=0){return{id:`draft_location_${Date.now()}_${e}`,name:"",description:""}}function xt(){const e=Bt(a.currentProjectData),t=V();return e.storyBible=e.storyBible||{},e.source=e.source||{},e.title=t.title||e.title||"",e.storyBible.summary=t.summary||e.storyBible.summary||"",e.storyBible.characters=t.characters,e.storyBible.chapters=t.chapters,e.storyBible.locations=t.locations,e.source.title=e.title||e.source.title||"",e}function jt(e,t){if(!e||!a.currentProjectData)return;const n=xt();if(n.storyBible=n.storyBible||{},e==="add-character"){const i=Array.isArray(n.storyBible.characters)?n.storyBible.characters:[];i.push($t(i.length)),n.storyBible.characters=i}if(e==="remove-character"){const i=t.closest('[data-preview-item="character"]'),r=Number((i==null?void 0:i.dataset.index)??-1);n.storyBible.characters=(n.storyBible.characters||[]).filter((o,s)=>s!==r)}if(e==="add-chapter"){const i=Array.isArray(n.storyBible.chapters)?n.storyBible.chapters:[];i.push(Lt(i.length)),n.storyBible.chapters=i}if(e==="remove-chapter"){const i=t.closest('[data-preview-item="chapter"]'),r=Number((i==null?void 0:i.dataset.index)??-1);n.storyBible.chapters=(n.storyBible.chapters||[]).filter((o,s)=>s!==r)}if(e==="add-location"){const i=Array.isArray(n.storyBible.locations)?n.storyBible.locations:[];i.push(Pt(i.length)),n.storyBible.locations=i}if(e==="remove-location"){const i=t.closest('[data-preview-item="location"]'),r=Number((i==null?void 0:i.dataset.index)??-1);n.storyBible.locations=(n.storyBible.locations||[]).filter((o,s)=>s!==r)}a.currentProjectData=n,j(n),p("本地预览已更新，记得保存后再进入工作台。","pending")}function X(e,t){return Array.from(document.querySelectorAll(`[data-preview-collection="${e}"] [data-preview-item="${e}"]`)).map((n,i)=>t(n,i))}function V(){var e,t,n,i,r,o,s,m,l;return{title:((e=document.getElementById("import-preview-title"))==null?void 0:e.value.trim())||((t=a.currentProjectData)==null?void 0:t.title)||"",summary:((n=document.getElementById("import-preview-summary-input"))==null?void 0:n.value.trim())||((r=(i=a.currentProjectData)==null?void 0:i.storyBible)==null?void 0:r.summary)||"",adaptationMode:((o=document.getElementById("import-preview-adaptation-mode"))==null?void 0:o.value)||((s=a.currentProjectData)==null?void 0:s.adaptationMode)||"balanced",gameType:((m=document.getElementById("import-preview-game-type"))==null?void 0:m.value)||((l=a.currentProjectData)==null?void 0:l.gameType)||a.currentGameType||"custom",characters:X("character",(c,u)=>{var g,v,G;return{id:c.dataset.itemId||`import_char_${u+1}`,name:((g=c.querySelector('[data-field="name"]'))==null?void 0:g.value.trim())||"",role:((v=c.querySelector('[data-field="role"]'))==null?void 0:v.value.trim())||"",description:((G=c.querySelector('[data-field="description"]'))==null?void 0:G.value.trim())||""}}).filter(c=>c.name||c.role||c.description),chapters:X("chapter",(c,u)=>{var g,v;return{id:c.dataset.itemId||`chapter_${u+1}`,title:((g=c.querySelector('[data-field="title"]'))==null?void 0:g.value.trim())||`章节 ${u+1}`,summary:((v=c.querySelector('[data-field="summary"]'))==null?void 0:v.value.trim())||""}}).filter(c=>c.title||c.summary),locations:X("location",(c,u)=>{var g,v;return{id:c.dataset.itemId||`import_loc_${u+1}`,name:((g=c.querySelector('[data-field="name"]'))==null?void 0:g.value.trim())||"",description:((v=c.querySelector('[data-field="description"]'))==null?void 0:v.value.trim())||""}}).filter(c=>c.name||c.description)}}function j(e=a.currentProjectData){var _,H,R,F,se,le,de,me,ue,pe,fe,ge,ye,ve,be,he,we,Ie,Ee,Se,ke,Be,$e;if(!e)return;const t=document.getElementById("import-preview-summary"),n=document.getElementById("import-preview-characters"),i=document.getElementById("import-preview-chapters"),r=document.getElementById("import-preview-visuals"),o=((_=e.storyBible)==null?void 0:_.summary)||((H=e.source)==null?void 0:H.excerpt)||"",s=Array.isArray((R=e.storyBible)==null?void 0:R.themes)&&e.storyBible.themes.length?e.storyBible.themes.join("、"):"待补充",m=Array.isArray((F=e.storyBible)==null?void 0:F.characters)?e.storyBible.characters:[],l=Array.isArray((se=e.storyBible)==null?void 0:se.chapters)?e.storyBible.chapters:[],c=Array.isArray((le=e.storyBible)==null?void 0:le.locations)?e.storyBible.locations:[],u=c.slice(0,5).map(E=>E.name).filter(Boolean).join("、"),g=m.slice(0,4).map(E=>E.name).filter(Boolean).join("、"),v=c.slice(0,4).map(E=>E.name).filter(Boolean).join("、"),G=((me=(de=e.visualBible)==null?void 0:de.styleProfile)==null?void 0:me.atmosphere)||"待确认";if(t&&(t.innerHTML=`
        ...
        `),n){const E=m.length?m.map((S,U)=>`
                <article class="preview-edit-item" data-preview-item="character" data-index="${U}" data-item-id="${B(S.id||"")}">
                    <div class="preview-meta-row">
                        <div class="preview-field">
                            <label>角色名</label>
        ...
        `}if(i){const E=l.length?l.map((S,U)=>`
                <article class="preview-edit-item" data-preview-item="chapter" data-index="${U}" data-item-id="${B(S.id||"")}">
                    <div class="preview-field">
                        <label>章节标题</label>
        ...
        `}if(r){const E=c.length?c.map((Q,tt)=>`
            ...
            `).join(""):'<p class="empty-hint">地点越准，后面的场景基准图就越稳。</p>',S=((pe=(ue=e.visualBible)==null?void 0:ue.styleProfile)==null?void 0:pe.stylePreset)||"cinematic_cn_rpg",U=((fe=e.config)==null?void 0:fe.refinement)||{},Le=((ge=e.gameDesign)==null?void 0:ge.branchingPolicy)||{},et=`每章分支上限 ${Le.maxBranchPerChapter||"-"}，锚点保留率 ${Le.mustKeepAnchorRate||"-"}`;r.innerHTML=`
            <div class="preview-card-header">
        ...
        `,Ct(((Ie=e.visualBible)==null?void 0:Ie.assetIndex)||[]),(Ee=document.getElementById("generate-base-assets"))==null||Ee.addEventListener("click",async()=>{await Ue()}),(Se=document.getElementById("rebuild-adaptation-btn"))==null||Se.addEventListener("click",async()=>{await We()}),(ke=document.getElementById("rebuild-visual-bible-btn"))==null||ke.addEventListener("click",async()=>{await Je()}),(Be=document.getElementById("apply-project-refinement-btn"))==null||Be.addEventListener("click",async()=>{await ze()}),($e=document.getElementById("export-project-package-btn"))==null||$e.addEventListener("click",async()=>{await Ve()})}}function Ct(e=[]){const t=document.getElementById("project-asset-list");if(t){if(!Array.isArray(e)||!e.length){t.innerHTML='<p class="empty-hint">暂无视觉资产，可先生成基准图。</p>';return}t.innerHTML=e.slice(0,8).map(n=>`
        <article class="preview-edit-item">
    ...
    `).join("")}}async function Ue(){var t,n;if(!a.currentProjectId){p("请先导入并保存项目。","error");return}const e=$();!e.enableImages||e.imageSource==="none"?p("当前图像生成未启用，将先以规划模式创建资产索引。","pending"):p("正在生成角色/地点基准图，请稍候...","pending");try{const i={dryRun:!e.enableImages||e.imageSource==="none",characterLimit:4,locationLimit:4,imageConfig:e.imageSource==="comfyui"?{...e,...ie()}:e},r=await f(`/projects/${a.currentProjectId}/assets/generate-base`,y("POST",i)),o=await f(`/projects/${a.currentProjectId}`);a.currentProjectData=o.project||a.currentProjectData,j(a.currentProjectData),p(i.dryRun?`已创建 ${((t=r.generatedAssets)==null?void 0:t.length)||0} 条资产规划。`:`已生成 ${((n=r.generatedAssets)==null?void 0:n.length)||0} 个基准资产。`,"success")}catch(i){p(`基准图生成失败：${i.message}`,"error")}}function qe(){var i,r,o;const e=((i=document.getElementById("preview-style-preset"))==null?void 0:i.value.trim())||"",t=((r=document.getElementById("preview-pacing"))==null?void 0:r.value)||"balanced",n=Number(((o=document.getElementById("preview-adaptation-strength"))==null?void 0:o.value)??.5);return{pacing:t,refinement:{adaptationStrength:Number.isFinite(n)?Math.max(0,Math.min(1,n)):.5},styleProfile:e?{stylePreset:e}:{}}}async function We(){if(!a.currentProjectId){p("请先导入并保存项目。","error");return}p("正在重算改编结构...","pending");try{const e=V(),t=await f(`/projects/${a.currentProjectId}/adaptation/rebuild`,y("POST",{gameType:e.gameType,adaptationMode:e.adaptationMode}));a.currentProjectData=t.project||a.currentProjectData,j(a.currentProjectData),p("改编结构已重算。","success")}catch(e){p(`重算失败：${e.message}`,"error")}}async function Je(){if(!a.currentProjectId){p("请先导入并保存项目。","error");return}p("正在重建视觉圣经...","pending");try{const e=qe(),t=await f(`/projects/${a.currentProjectId}/visual-bible/rebuild`,y("POST",{styleProfile:e.styleProfile}));a.currentProjectData=t.project||a.currentProjectData,j(a.currentProjectData),p("视觉圣经已重建。","success")}catch(e){p(`重建失败：${e.message}`,"error")}}async function ze(){if(!a.currentProjectId){p("请先导入并保存项目。","error");return}p("正在应用校正参数...","pending");try{const e=V(),t=qe(),n=await f(`/projects/${a.currentProjectId}/refine`,y("POST",{...t,adaptationMode:e.adaptationMode}));a.currentProjectData=n.project||a.currentProjectData,j(a.currentProjectData),p("校正参数已应用。","success")}catch(e){p(`应用失败：${e.message}`,"error")}}function Tt(e,t){const n=new Blob([JSON.stringify(t,null,2)],{type:"application/json;charset=utf-8"}),i=URL.createObjectURL(n),r=document.createElement("a");r.href=i,r.download=e,document.body.appendChild(r),r.click(),document.body.removeChild(r),URL.revokeObjectURL(i)}async function Ve(){var e;if(!a.currentProjectId){p("请先导入并保存项目。","error");return}p("正在导出项目包...","pending");try{const n=(await f(`/projects/${a.currentProjectId}/export-package`)).package||{},i=`${(((e=a.currentProjectData)==null?void 0:e.title)||"project").replace(/[\\/:*?"<>|]/g,"_")}_package.json`;Tt(i,n),p("项目包导出成功。","success")}catch(t){p(`导出失败：${t.message}`,"error")}}async function Ke(e={}){if(!a.currentProjectId)return p("当前没有可保存的导入项目，请重新导入。","error"),null;const t=e.showStatus!==!1;t&&p("正在保存导入项目修改...","pending");try{const n=await f(`/projects/${a.currentProjectId}/update`,y("POST",{edits:V()}));return a.currentProjectData=n.project||a.currentProjectData,a.currentProjectData&&(document.getElementById("import-title").value=a.currentProjectData.title||""),j(a.currentProjectData),t&&p(e.successMessage||"导入项目修改已保存。","success"),a.currentProjectData}catch(n){return console.error("Save imported project edits error:",n),t&&p(n.message,"error"),null}}async function Gt(){var n,i,r,o,s;const e=((n=document.getElementById("import-content"))==null?void 0:n.value.trim())||"";if(!e){h("请先粘贴要导入的长文本内容。","error");return}const t=I(D());a.currentGenerationConfig=t,P(),h("正在解析长文本并创建项目...","pending");try{const m={title:((i=document.getElementById("import-title"))==null?void 0:i.value.trim())||"",content:e,gameType:((r=document.getElementById("import-game-type"))==null?void 0:r.value)||"custom",adaptationMode:((o=document.getElementById("adaptation-mode"))==null?void 0:o.value)||"balanced"},l=await f("/projects/import-text",y("POST",m));a.currentProjectId=((s=l.project)==null?void 0:s.id)||null,a.currentProjectData=l.project||null,a.currentGameType=m.gameType,j(l.project),h("导入成功，请先检查提取结果，再决定是否进入工作台。","success"),p("可以先轻量修改角色、章节和地点，再确认进入工作台。"),await q(),b("import-preview-screen")}catch(m){console.error("Imported project init error:",m),h(m.message,"error")}}async function At(){var t,n;if(!a.currentProjectId){h("当前没有可用的导入项目，请重新导入。","error"),b("import-screen");return}const e=I(D());a.currentGenerationConfig=e,P();try{const i=await Ke({successMessage:"修改已保存，正在进入生成工作台..."});if(!i)return;const r=await f(`/projects/${a.currentProjectId}/init-session`,y("POST",{config:e,gameType:i.gameType||a.currentGameType||"custom",userInput:((t=i.storyBible)==null?void 0:t.summary)||((n=i.source)==null?void 0:n.excerpt)||""}));await Fe(r),h("导入项目已进入生成工作台。","success")}catch(i){console.error("Start imported project session error:",i),h(i.message,"error"),p(i.message,"error"),b("import-screen")}}async function q(){const e=document.getElementById("import-project-list");if(e){e.innerHTML='<p class="empty-hint">正在加载项目列表...</p>';try{const t=await f("/projects"),n=Array.isArray(t.projects)?t.projects:[];if(!n.length){e.innerHTML='<p class="empty-hint">还没有导入项目。</p>';return}e.innerHTML=n.map(i=>`
        ...
        `).join(""),e.querySelectorAll('[data-action="open"]').forEach(i=>{i.addEventListener("click",async()=>{const r=i.closest("[data-project-id]"),o=r==null?void 0:r.getAttribute("data-project-id");o&&await Dt(o)})}),e.querySelectorAll('[data-action="delete"]').forEach(i=>{i.addEventListener("click",async()=>{const r=i.closest("[data-project-id]"),o=r==null?void 0:r.getAttribute("data-project-id");o&&await Mt(o)})})}catch(t){e.innerHTML=`<p class="empty-hint">项目列表加载失败：${d(t.message)}</p>`}}}async function Dt(e){var t,n;try{const i=await f(`/projects/${e}`);a.currentProjectId=((t=i.project)==null?void 0:t.id)||e,a.currentProjectData=i.project||null,a.currentGameType=((n=i.project)==null?void 0:n.gameType)||a.currentGameType,a.currentProjectData&&(document.getElementById("import-title").value=a.currentProjectData.title||"",a.currentGameType=a.currentProjectData.gameType||a.currentGameType),j(a.currentProjectData),h("已加载导入项目，你可以继续修改。","success"),p("项目已加载，可直接修改并继续进入工作台。"),b("import-preview-screen")}catch(i){h(`加载项目失败：${i.message}`,"error")}}async function Mt(e){if(confirm("确定删除这个导入项目吗？删除后不可恢复。"))try{await f(`/projects/${e}`,y("DELETE",{})),a.currentProjectId===e&&(a.currentProjectId=null,a.currentProjectData=null),await q(),h("项目已删除。","success")}catch(t){h(`删除项目失败：${t.message}`,"error")}}function Nt(){document.getElementById("generate-only-btn").addEventListener("click",async()=>{a.currentStepId&&await _t(a.currentStepId)}),document.getElementById("regenerate-btn").addEventListener("click",async()=>{await Te(prompt("请输入重生成补充要求（可留空）：")||"")}),document.getElementById("modify-btn").addEventListener("click",()=>{document.getElementById("custom-input-area").style.display="block",document.getElementById("custom-feedback").focus()}),document.getElementById("apply-custom-btn").addEventListener("click",async()=>{const e=document.getElementById("custom-feedback").value.trim();e&&(await Te(e),document.getElementById("custom-feedback").value="",document.getElementById("custom-input-area").style.display="none")}),document.getElementById("confirm-btn").addEventListener("click",async()=>{await qt()}),document.getElementById("skip-btn").addEventListener("click",async()=>{await Wt()}),document.getElementById("gen-finalize-btn").addEventListener("click",async()=>{await Kt()})}function O(){const e=document.getElementById("step-navigation");e.innerHTML="",a.allSteps.forEach(t=>{const n=L(t.id),i=A[t.id]||{icon:"?",name:t.name||t.id},r=document.createElement("button");r.type="button",r.className="step",t.id===a.currentStepId&&r.classList.add("active"),n.status==="confirmed"&&r.classList.add("completed"),n.status==="loading"&&r.classList.add("generating"),r.innerHTML=`<span class="step-icon">${i.icon}</span><span class="step-label">${t.name||i.name}</span>`,r.addEventListener("click",async()=>{await Ot(t.id)}),e.appendChild(r)})}async function Ot(e,t){a.currentStepId=e,O(),L(e);{T(e);return}}function T(e){const t=A[e]||{name:e,desc:""},n=L(e);document.getElementById("current-step-name").textContent=t.name,document.getElementById("current-step-desc").textContent=t.desc,document.getElementById("step-loading").style.display=n.status==="loading"?"flex":"none",document.getElementById("action-buttons").style.display="flex",Ye(e),Qe(),K(e)}async function _t(e){var n;const t=L(e);t.status="loading",T(e),w("calling",`正在生成 ${((n=A[e])==null?void 0:n.name)||e}...`);try{const i=await f("/generate/step",y("POST",{sessionId:a.currentSessionId,stepId:e,options:{candidateCount:2}}));t.candidates=i.candidates||[],t.selectedIndex=-1,t.status="generated",t.history.push({id:Date.now(),timestamp:new Date,candidates:t.candidates.map(r=>structuredClone(r))}),w("success",`已生成 ${t.candidates.length} 个候选方案。`)}catch(i){console.error("Load step error:",i),t.status="error",w("error",i.message)}T(e)}function Ye(e){const t=document.getElementById("candidates-container"),n=L(e);if(t.innerHTML="",n.status!=="loading"){if(!n.candidates.length){t.innerHTML='<div class="candidate-card"><div class="candidate-empty">当前步骤还没有生成内容。点击下方“生成”开始。</div></div>';return}n.candidates.forEach((i,r)=>{const o=document.createElement("button");o.type="button",o.className="candidate-card",n.selectedIndex===r&&o.classList.add("selected"),o.innerHTML=`
            <div class="candidate-card-header">
                <strong>${d(Ht(e,i,r))}</strong>
                <span>方案 ${r+1}</span>
            </div>
            <div class="candidate-card-content">${Rt(e,i)}</div>
        `,o.addEventListener("click",()=>{n.selectedIndex=r,Ye(e),K(e)}),t.appendChild(o)})}}function K(e){const t=L(e),n=t.candidates.length>0;document.getElementById("confirm-btn").disabled=t.selectedIndex<0,document.getElementById("regenerate-btn").disabled=!n,document.getElementById("modify-btn").disabled=!n,document.getElementById("gen-finalize-btn").style.display=a.allSteps.every(i=>L(i.id).status==="confirmed")?"inline-block":"none"}function Ht(e,t,n){var i,r;return e==="worldview"?t.worldName||`世界观方案 ${n+1}`:e==="mainPlot"?t.title||`主线方案 ${n+1}`:e==="integration"?t.gameName||`整合方案 ${n+1}`:Array.isArray(t)?`${((i=A[e])==null?void 0:i.name)||e} · ${t.length} 项`:t.name||t.title||`${((r=A[e])==null?void 0:r.name)||e} 方案 ${n+1}`}function Rt(e,t){var n,i,r,o,s,m;if(t!=null&&t.error)return k("解析提示",t.error||"AI 响应暂时无法解析，请尝试重新生成。");if(typeof t=="string")return k("方案内容",t);switch(e){case"worldview":return[M("世界名称",t.worldName),M("时代背景",t.era),k("世界描述",t.description),je("世界规则",t.rules),Ce("主要势力",t.factions,["name","description"]),Ce("重要地点",t.locations,["name","description"])].join("");case"mainPlot":return[M("主线标题",t.title),M("核心主题",t.theme),k("剧情概览",t.summary),k("引发事件",t.incitingIncident),Ut("章节结构",(t.chapters||[]).map(l=>({title:l.name||l.title,body:`${l.goal||""}${l.description?`：${l.description}`:""}`}))),k("高潮",t.climax),k("结局说明",t.resolution)].join("");case"integration":return[M("游戏名称",t.gameName),k("玩法设计",t.gameplayDesign),M("战斗类型",(i=(n=t.gameSystems)==null?void 0:n.combatSystem)==null?void 0:i.type),je("战斗机制",(o=(r=t.gameSystems)==null?void 0:r.combatSystem)==null?void 0:o.mechanics),k("开场场景",(s=t.openingScene)==null?void 0:s.description),k("开场旁白",(m=t.openingScene)==null?void 0:m.narration),k("平衡性说明",t.balancingNotes)].join("");default:return Ft(t,e)}}function Ft(e,t){const n=Array.isArray(e)?e:e?[e]:[];return n.length?n.map((i,r)=>{var l;const o=i.name||i.title||`${((l=A[t])==null?void 0:l.name)||"条目"} ${r+1}`,s=i.description||i.summary||i.role||i.type||"",m=[i.role?`<span class="candidate-chip">${d(i.role)}</span>`:"",i.location?`<span class="candidate-chip">${d(i.location)}</span>`:"",i.type?`<span class="candidate-chip">${d(i.type)}</span>`:"",i.rarity?`<span class="candidate-chip">${d(i.rarity)}</span>`:""].join("");return`
...
`,"<br>")}</div>
    ...
    `:""}function je(e,t){return!Array.isArray(t)||!t.length?"":`
        <div class="candidate-block">
            <div class="candidate-label">${d(e)}</div>
            <div class="candidate-chip-row">${t.map(n=>`<span class="candidate-chip">${d(n)}</span>`).join("")}</div>
        </div>
    `}function Ce(e,t,n){return!Array.isArray(t)||!t.length?"":`
        <div class="candidate-block">
            <div class="candidate-label">${d(e)}</div>
            ${t.map(i=>`
                <div class="candidate-item">
    ...
    `}function Ut(e,t){return!Array.isArray(t)||!t.length?"":`
        <div class="candidate-block">
            <div class="candidate-label">${d(e)}</div>
            ${t.map(n=>`
                <div class="candidate-item">
    ...
    `).join(""),t.querySelectorAll("[data-choice-index]").forEach(n=>{n.addEventListener("click",async()=>{const i=Number(n.getAttribute("data-choice-index")),r=e[i];r&&await ne(r.action||r.text||"")})})}}function Jt(e={}){const t=document.getElementById("player-stats");if(!t)return;const n=Object.entries(e||{});if(!n.length){t.innerHTML='<p class="empty-hint">暂无属性信息</p>';return}t.innerHTML=n.map(([i,r])=>{if(r&&typeof r=="object"&&Number.isFinite(r.current)&&Number.isFinite(r.max)){const o=r.max>0?Math.max(0,Math.min(100,r.current/r.max*100)):0;return`
        ...
        `}).join("")}function zt(e=[]){const t=document.getElementById("inventory-list");if(t){if(!Array.isArray(e)||!e.length){t.innerHTML="<li>暂无物品</li>";return}t.innerHTML=e.map(n=>`<li>${d(n.name||String(n))}</li>`).join("")}}function Vt(e=[]){const t=document.getElementById("quest-list");if(t){if(!Array.isArray(e)||!e.length){t.innerHTML="<li>暂无任务</li>";return}t.innerHTML=e.map(n=>`
        <li class="${n.completed?"completed":""}">
            ${d(n.name||n.description||"未命名任务")}
            ${n.progress?` · ${d(n.progress)}`:""}
        </li>
    `).join("")}}async function Ze(e=a.currentGameId){if(e)try{const t=await f(`/games/${e}/start`,y("POST",{}));a.currentGameId=e,a.gameState=t.gameState||null,a.sceneImages=[],a.selectedSceneImageIndex=0,a.activeSceneImage="",a.transitioningSceneImage="",a.currentVisualSignature="",document.getElementById("game-log").innerHTML="",Xe([]),Y([]),b("game-screen"),ce(a.gameState)}catch(t){alert(`启动游戏失败：${t.message}`)}}async function Kt(){var e;if(!a.currentSessionId){alert("当前没有生成会话。");return}w("calling","正在整合并生成最终游戏...");try{const t=await f(`/generate/${a.currentSessionId}/finalize`,y("POST",{config:$()}));a.currentGameId=t.gameId,a.currentGameData=t.gameData||null,a.currentGameType=((e=t.gameData)==null?void 0:e.type)||a.currentGameType,await Ze(a.currentGameId),w("success","游戏已生成并启动。")}catch(t){w("error",t.message),alert(`整合失败：${t.message}`)}}async function ne(e=""){var r,o;if(!a.currentGameId)return;const t=document.getElementById("player-input"),n=document.getElementById("send-btn"),i=e||(t==null?void 0:t.value.trim())||"";if(i){t&&(t.value=""),n&&(n.disabled=!0),N("player",i,"你");try{const s=$(),m=s.imageSource==="comfyui"?{...s,...ie()}:s,l=await f(`/games/${a.currentGameId}/action`,y("POST",{action:i,imageConfig:m}));Array.isArray((r=l.gameState)==null?void 0:r.lastDialogues)&&l.gameState.lastDialogues.forEach(c=>{c!=null&&c.content&&N("narrator",c.content,c.speaker||"角色")}),l.response&&N("narrator",l.response),l.gameOver&&l.gameOverMessage&&N("system",l.gameOverMessage),Xe(l.choices||[]),ce(l.gameState||a.gameState),l.sceneImage&&Y([l.sceneImage],((o=l.visualState)==null?void 0:o.prompt)||l.sceneDescription||l.response)}catch(s){N("system",`行动处理失败：${s.message}`)}finally{n&&(n.disabled=!1)}}}function Yt(){var e,t,n,i,r,o,s,m,l;ut(),document.getElementById("send-btn").addEventListener("click",ne),document.getElementById("player-input").addEventListener("keydown",c=>{c.key==="Enter"&&ne()}),(e=document.getElementById("generate-scene-image-btn"))==null||e.addEventListener("click",async()=>{await Qt()}),(t=document.getElementById("scene-image-count"))==null||t.addEventListener("change",()=>{const c=document.getElementById("scene-image-count"),u=document.getElementById("comfyui-image-count"),g=String(Math.max(1,Math.min(8,Number(c.value)||1)));c.value=g,u&&(u.value=g),P()}),(n=document.getElementById("live-comfyui-workflow-mode"))==null||n.addEventListener("change",()=>{pt(),syncLiveImageConfigState()}),(i=document.getElementById("live-refresh-comfyui-btn"))==null||i.addEventListener("click",async()=>{await refreshLiveComfyUIOptions(!0)}),(r=document.getElementById("live-refresh-workflow-files-btn"))==null||r.addEventListener("click",async()=>{await refreshLiveComfyWorkflowFiles(!0)}),(o=document.getElementById("live-load-workflow-btn"))==null||o.addEventListener("click",async()=>{await loadSelectedLiveWorkflowFile(!0)}),(s=document.getElementById("live-test-comfyui-btn"))==null||s.addEventListener("click",async()=>{await testLiveComfyUIConnection()}),(m=document.getElementById("live-validate-workflow-btn"))==null||m.addEventListener("click",async()=>{await validateLiveComfyUIWorkflow()}),(l=document.getElementById("live-comfyui-workflow-file"))==null||l.addEventListener("change",()=>{syncLiveImageConfigState()}),document.querySelectorAll("#live-image-config input, #live-image-config select, #live-image-config textarea").forEach(c=>{c.addEventListener("change",()=>{syncLiveImageConfigState()})}),document.getElementById("game-menu-btn").addEventListener("click",()=>{document.getElementById("game-menu-modal").classList.add("active")}),document.getElementById("save-game").addEventListener("click",async()=>{var c,u;if(a.gameState&&a.currentGameId)try{const g=await f(`/games/${a.currentGameId}`),v=xe(a.currentGameId,g.state||a.gameState,{gameData:g.game||a.currentGameData,generationConfig:$(),type:a.currentGameType||((c=g.game)==null?void 0:c.type)||((u=a.gameState)==null?void 0:u.type)||"custom"});a.currentGameData=g.game||a.currentGameData,localStorage.setItem(`rpg_save_${a.currentGameId}`,JSON.stringify(v)),alert("游戏进度已保存。")}catch(g){console.error("Save game error:",g);const v=xe(a.currentGameId,a.gameState,{generationConfig:$()});localStorage.setItem(`rpg_save_${a.currentGameId}`,JSON.stringify(v)),alert("游戏进度已保存，但这次没有拿到完整后端快照。若服务重启后要续玩，建议重新保存一次。")}document.getElementById("game-menu-modal").classList.remove("active")}),document.getElementById("load-game").addEventListener("click",async()=>{if(!a.currentGameId){document.getElementById("game-menu-modal").classList.remove("active");return}re(`rpg_save_${a.currentGameId}`)?await Re(a.currentGameId):alert("没有找到存档。"),document.getElementById("game-menu-modal").classList.remove("active")}),document.getElementById("restart-game").addEventListener("click",async()=>{a.currentGameId&&await Ze(a.currentGameId),document.getElementById("game-menu-modal").classList.remove("active")}),W(),syncLiveImageConfigPanel()}async function Qt(){var s,m;if(!a.currentGameId){C("Start the game before generating images.","error");return}const e=document.getElementById("scene-image-prompt"),t=document.getElementById("scene-image-count"),n=document.getElementById("comfyui-image-count"),i=(e==null?void 0:e.value.trim())||((s=a.gameState)==null?void 0:s.sceneDescription)||((m=a.gameState)==null?void 0:m.initialLog)||"",r=Math.max(1,Math.min(8,Number(t==null?void 0:t.value)||1));if(!i){C("No scene prompt available yet.","error");return}t&&(t.value=String(r)),n&&(n.value=String(r));const o=$().imageSource==="comfyui"?{...$(),...ie(),comfyuiImageCount:r}:{...$(),comfyuiImageCount:r};a.currentGenerationConfig=o,localStorage.setItem(z,JSON.stringify(o)),Ge(!0),C("Generating images with ComfyUI...","pending");try{const l=await f(`/games/${a.currentGameId}/generate-image`,y("POST",{prompt:i,count:r,comfyuiImageCount:r,...o}));a.selectedSceneImageIndex=0,Y(l.images||[],l.prompt||i),C(`Generated ${l.count||(l.images||[]).length} image(s).`,"success")}catch(l){console.error("Generate scene image error:",l),C(l.message,"error")}finally{Ge(!1)}}function C(e,t=""){const n=document.getElementById("scene-image-status");n&&(n.textContent=e,n.className=`helper-text ${t}`.trim())}function Ge(e){const t=document.getElementById("generate-scene-image-btn");t&&(t.disabled=!!e,t.textContent=e?"生成中...":"生成场景图")}function W(){var s,m;const e=document.getElementById("scene-image-controls"),t=document.getElementById("scene-image-prompt"),n=document.getElementById("scene-image-count"),i=document.getElementById("live-image-config"),r=$(),o=r.enableImages&&r.imageSource!=="none";if(e&&(e.style.display=o?"block":"none"),!o){C("当前未启用图像生成。","pending");return}if(t){const l=a.lastSuggestedImagePrompt||((s=a.gameState)==null?void 0:s.sceneDescription)||((m=a.gameState)==null?void 0:m.initialLog)||"";(!t.value.trim()||t.value===a.lastSuggestedImagePrompt)&&(t.value=l),a.lastSuggestedImagePrompt=l}n&&(n.value=String(Math.max(1,Math.min(8,Number(r.comfyuiImageCount)||1)))),i&&(i.style.display=r.imageSource==="comfyui"?"block":"none"),r.imageGenerationMode==="auto"?C("当前为自动生图模式：视觉场景变化时会自动更新。","pending"):C("当前为手动生图模式：点击按钮后才会生成。","pending")}function Y(e=[],t=""){a.sceneImages=Array.isArray(e)?e:[],a.selectedSceneImageIndex=0,t&&(a.lastSuggestedImagePrompt=t);const n=document.getElementById("scene-image-gallery");n&&(a.sceneImages.length?(n.innerHTML=a.sceneImages.map((r,o)=>`
                    <button
                        type="button"
        ...
        `)},i.src=e}function Xt(e=a.gameState){return e?{chapterId:e.currentChapter??null,sceneNodeId:e.currentScene||null,plotBeatId:e.turn??null,playerState:e.player||{},worldState:e.worldState||{},relationshipState:e.characterStates||[],inventory:e.inventory||[],activeQuests:(e.quests||[]).filter(t=>t&&t.completed!==!0),visualState:e.visualState||null,history:(e.history||[]).slice(-20)}:null}function Zt(){!a.currentProjectId||!a.gameState||a.runtimeSnapshotSaving||(a.runtimeSnapshotTimer&&window.clearTimeout(a.runtimeSnapshotTimer),a.runtimeSnapshotTimer=window.setTimeout(async()=>{a.runtimeSnapshotSaving=!0;try{await f(`/projects/${a.currentProjectId}/runtime-snapshot`,y("POST",{runtimeSnapshot:Xt(a.gameState)}))}catch(e){console.warn("Runtime snapshot save failed:",e.message)}finally{a.runtimeSnapshotSaving=!1}},800))}function ce(e=a.gameState){var n,i;if(!e)return;a.gameState=e,a.currentVisualSignature=((n=e.visualState)==null?void 0:n.signature)||a.currentVisualSignature,document.getElementById("game-title").textContent=e.name||"AI 生成 RPG",document.getElementById("scene-description").textContent=e.sceneDescription||"";const t=document.getElementById("game-log");e.initialLog&&!t.children.length&&N("narrator",e.initialLog),Jt(((i=e.player)==null?void 0:i.stats)||{}),zt(e.inventory||[]),Vt(e.quests||[]),W(),Zt()}async function J(e){const t=document.getElementById(`test-${e}-result`),n=document.getElementById(`test-${e}-btn`);n.disabled=!0,t.textContent="测试中...",t.className="test-result";try{const i=await f("/test-connection",y("POST",ae(e)));t.textContent=i.success?"连接成功":i.error||"连接失败",t.className=`test-result ${i.success?"success":"error"}`}catch(i){t.textContent=i.message,t.className="test-result error"}finally{n.disabled=!1}}function B(e){return d(e).replaceAll('"',"&quot;").replaceAll("'","&#39;")}function d(e){return String(e).replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;")}
